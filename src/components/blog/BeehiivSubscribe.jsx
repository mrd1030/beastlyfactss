  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="space-y-3">
        {/* Email Input - Fixed for Lighthouse */}
        <div>
      ...
      {success && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="bg-card border border-border rounded-3xl p-8 max-w-sm w-full text-center relative landscape:max-h-[85dvh] landscape:overflow-y-auto">
            <button
