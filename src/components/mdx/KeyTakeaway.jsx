  ...
  return (
    <div className={`my-8 rounded-2xl border border-accent/30 border-l-4 border-l-accent bg-accent/5 p-6 ${className}`}>
      <div className="flex items-start gap-3">
        <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-accent/10 text-accent-ink">
          <Target className="h-4 w-4" />
        </div>
        <div className="flex-1">
          <div className="mb-1 text-xs font-body font-bold uppercase tracking-wider text-accent-ink">
            Key Takeaway
          </div>
