...
const CATEGORIES = [
  ...
  },
  {
    ...
    terms: [
      ...
      { term: 'Feather molt', definition: 'The process of shedding and regrowing feathers. A stressful, nutrient-demanding period that calls for extra care and a slightly adjusted diet.', related: [{ label: 'African Grey Parrot Care Guide', to: '/guides/african-grey-parrot/' }] },
      ...
      { term: 'Mimicry', definition: 'The ability of species like African Grey Parrots to copy sounds and human speech — closely tied to their intelligence and need for ongoing mental stimulation.', related: [{ label: 'African Grey Parrot Care Guide', to: '/guides/african-grey-parrot/' }] },
  ...
  },
  {
    ...
    emoji: '🐕',
    terms: [
      { term: 'Socialization', definition: 'Exposing a puppy or kitten to new people, animals, and environments during a critical early window, so they grow into a confident, well-adjusted adult.', related: [{ label: 'Labrador Retriever Care Guide', to: '/guides/labrador-retriever/' }] },
      ...
      { term: 'Brachycephalic', definition: 'Having a short, flat skull shape, as seen in French Bulldogs and Persian cats. Comes with specific breathing and heat-tolerance considerations worth knowing before bringing one home.', related: [{ label: 'French Bulldog Care Guide', to: '/guides/french-bulldog/' }] },
      { term: 'Double coat', definition: 'A coat with two layers: a soft insulating undercoat and a coarser top layer. Common in Siberian Huskies and Golden Retrievers, and the reason these breeds shed heavily during seasonal blowouts.', related: [{ label: 'Siberian Husky Care Guide', to: '/guides/siberian-husky/' }] },
      { term: 'Working / herding breed', definition: 'A breed group originally developed for a job like herding livestock, as with Border Collies. Often means very high exercise and mental stimulation needs in a pet setting.', related: [{ label: 'Border Collie Care Guide', to: '/guides/border-collie/' }] },
      ...
      { term: 'Bunting', definition: 'When a cat rubs or headbutts a person or object with its forehead, depositing scent from glands there. A sign of trust and affection, not aggression.', related: [{ label: 'Domestic Shorthair Care Guide', to: '/guides/domestic-shorthair/' }] },
      { term: 'Polydactyl', definition: 'Having extra toes — a genetic trait that shows up occasionally in certain cat lines, Maine Coons especially.', related: [{ label: 'Maine Coon Care Guide', to: '/guides/maine-coon/' }] },
