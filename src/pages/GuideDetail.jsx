...
export default function GuideDetail() {
  ...
  const SHORT_LABELS = { 'cost-guide': 'Cost guide', 'tank-setup-guide': 'Setup guide', 'feeding-guide': 'Feeding guide', 'health-issues-guide': 'Health guide', 'handling-guide': 'Handling guide', 'enrichment-guide': 'Enrichment guide', 'growth-weight-checks-guide': 'Growth guide', 'shopping-list': 'Shopping list', 'temperature-guide': 'Temperature guide', 'reptile-quarantine-guide': 'Quarantine guide', 'reptile-shedding-complete-guide': 'Shedding guide', 'reptile-salmonella-hygiene-guide': 'Hygiene guide', 'reptile-emergency-plan-guide': 'Emergency plan', 'small-mammal-temperature-heat-stress-guide': 'Heat and cold guide', 'small-mammal-grooming-nails-molting-guide': 'Grooming guide', 'small-mammal-vet-visits-and-travel-guide': 'Vet trips guide', 'tank-size-bowl-myth': 'Bowl myth guide', 'quarantine-and-treatment-guide': 'Quarantine guide', 'power-outage-and-transport-guide': 'Power outage guide' };
