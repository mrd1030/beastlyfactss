      ...
      <div className="bg-gradient-to-b from-primary/5 to-transparent pt-12 pb-8 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-xs text-muted-foreground font-body">Last updated: August 2, 2026</p>
          </motion.div>
        </div>
      </div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          ...
          <Section title="5. Third-Party Services">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong className="text-foreground">Supabase</strong> - hosts the database that stores comments, likes, and shares - <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline">Privacy Policy</a></li>
