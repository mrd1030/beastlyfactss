...
export const AFFILIATE_PRODUCTS = [
  ...
  },
  {
    ...
    rating: 4.7,
    price: "$8–$14",
    description: "Pressed plant-fibre tunnel that connects to a chamber, which is the structure shown to prevent stereotypic digging in gerbils. Edible, so it is chewing material too.",
