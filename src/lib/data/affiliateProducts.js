...
export const AFFILIATE_PRODUCTS = [
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-241.jpg",
    rating: 4.6,
    price: "$12–$16",
    description: "This clear plastic, shallow bathing dish clamps directly onto the cage bars with a twist-lock bracket, so it stays put but pops off in seconds for refilling and cleaning. Canaries and finches need frequent shallow baths to keep their feathers and skin in good condition, and this attaches inside almost any wire cage without taking up floor space or tipping over.",
    covers: ["Shallow bird bath"],
    pets: ["birds"],
  },
  {
    slug: "giant-millipede-organic-topsoil-substrate",
    product: "Josh's Frogs Milli Mix Millipede and Isopod Substrate, 2 Quarts",
    category: "Substrate",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B086R7Z52J?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-242.jpg",
    rating: 4.6,
    price: "$17–$21",
  ...
  {
    slug: "corydoras-hikari-sinking-wafers",
    product: "Hikari Tropical Sinking Wafers for Catfish, Loaches and Bottom Feeders, 3.88 oz",
    category: "Food & Treats",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B00025JZAY?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-243.jpg",
    rating: 4.8,
    price: "$8–$12",
  ...
  {
    slug: "green-anole-enclosure-24x24x24",
    product: "REPTIZOO 60 Gallon Glass Reptile Tank, 24\" x 24\" x 24\" Front Opening Terrarium",
    category: "Enclosures & Cages",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0C4Y6H19X?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-244.jpg",
    rating: 4.4,
    price: "$250–$270",
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-245.jpg",
    rating: 4.0,
    price: "$65–$75",
  ...
  {
    slug: "argentine-tegu-thermostat-heavy-duty",
    product: "MakerHawk TC816 Digital Temperature Controller Thermostat Timer, 1800W 120V 15A",
    category: "Heating & Lighting",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0BX418XDF?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-246.jpg",
    rating: 4.6,
    price: "$17–$23",
  ...
  // Batch 14: rat/mouse cage, wheel, and reptile thiamine gap-fill -
  // sourced live on Amazon 2026-08-27 (real ASINs; user-supplied product photos,
  // Amazon's page returned a bot-check wall for automated fetches this round).
  {
    slug: "rat-cage-prevue-495-rolling",
    product: "Prevue Pet Products Rolling Small Animal Cage, Model 495",
    category: "Enclosures & Cages",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B001W8MDKO?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-254.jpg",
    rating: 4.5,
    price: "$199.99",
  ...
  {
    slug: "rat-wheel-exotic-nutrition-silent-runner-12in-regular",
    product: "Exotic Nutrition Silent Runner 12in Regular + Cage Attachment",
    category: "Small Mammal & Exotic Pet Gear",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B01AFI3ERM?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-255.jpg",
    rating: 4.5,
    price: "$33.99",
  ...
  {
    slug: "reptile-multivitamin-repcal-herptivite",
    product: "Rep-Cal Herptivite Multivitamin with Beta Carotene, 3.3 oz",
    category: "Food & Supplements",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B07MMW2MV9?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-257.jpg",
    rating: 4.7,
    price: "$12.99",
  ...
  {
    slug: "mouse-cage-ferplast-favola",
    product: "Ferplast Favola Large Hamster Cage",
    category: "Enclosures & Cages",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0133LNVAS?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-258.jpg",
    rating: 4.4,
    price: "$89.99",
  ...
  {
    slug: "mouse-young-rat-food-oxbow-essentials",
    product: "Oxbow Essentials Mouse & Young Rat Food, 2.5 lb",
    category: "Food & Treats",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B00QPD1MXA?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-256.jpg",
    rating: 4.8,
    price: "$10.99",
    description: "Nutritionally complete pellet formulated specifically for young, growing rats and mice, not a repurposed hamster or gerbil mix.",
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-259.jpg",
    rating: 4.5,
    price: "$15–$20",
    description: "Wooden lidded foraging puzzle sized for small pets rather than dogs. Hides part of the daily ration behind a problem the animal has to solve.",
    covers: ["Foraging or puzzle feeder for small mammals"],
    altGroup: "small-pet-foraging",
    pets: ["small-mammals"],
  },
  {
    ...
    image: "/assets/images/affiliate/product-260.jpg",
    rating: 4.5,
    price: "$10–$16",
    description: "Fabric foraging pad that hides food among fleece strips, so feeding becomes scent-led searching rather than solving a lid. Machine washable.",
    covers: ["Snuffle mat or scatter-feeding mat for small mammals"],
    altGroup: "small-pet-foraging",
    pets: ["small-mammals"],
  },
  {
    slug: "small-animal-tunnel",
    ...
    image: "/assets/images/affiliate/product-261.jpg",
    rating: 4.4,
    price: "$8–$14",
    description: "Collapsible corner tunnel that gives connected cover across an enclosure, so a prey species will actually cross open floor instead of hugging the walls.",
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-263.jpg",
    rating: 4.1,
    price: "$7–$12",
    description: "Rolling dispenser that sheds insects as it moves. Matches how a bearded dragon actually works at food, by pushing and nosing rather than manipulating.",
    covers: ["Rolling treat dispenser for reptiles"],
    altGroup: "reptile-puzzle-feeding",
    pets: ["reptiles-amphibians"],
  },
  {
    slug: "target-stick-clicker",
    product: "Parrot Wizard Training Clicker and Target Stick",
    category: "Decor & Enrichment",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B07GBC85T9?tag=beastlyfacts-20",
    image: "/assets/images/affiliate/product-265.jpg",
    rating: 4.2,
    price: "$8–$14",
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-266.jpg",
    rating: 4.7,
    price: "$8–$14",
    description: "Pressed plant-fiber tunnel that connects to a chamber, which is the structure shown to prevent stereotypic digging in gerbils. Edible, so it is chewing material too.",
  ...
  },
  {
    ...
    image: "/assets/images/affiliate/product-264.jpg",
    rating: 4.0,
    price: "$15–$25",
  ...
  // Birdwatching and wild-bird gear. Unlike everything above, these serve wild
  // birds and the people watching them, not a pet in a cage, so `pets` is empty
  // on purpose: a budgie keeper filtering /gear/category/birds/ should not be
  // shown a spotting harness or 25lb of sunflower seed. They still list under
  // their own category on the unfiltered gear page. `covers` is empty because no
  // Cost Builder line item matches them.
  {
    slug: "binoculars-celestron-nature-dx-8x42",
    product: "Celestron Nature DX 8x42 Binoculars",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0B7CNPNJV?tag=beastlyfacts-20",
    rating: 4.5,
    price: "$129–$149",
    description: "Entry-level 8x42 with phase-coated BaK-4 prisms and a 7.4 degree field of view. The usual answer to what a first birding binocular should be.",
    covers: [],
    altGroup: "birding-binoculars",
    pets: [],
  },
  {
    slug: "binoculars-celestron-nature-dx-ed-8x42",
    product: "Celestron Nature DX ED 8x42 Binoculars",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B00KV718JE?tag=beastlyfacts-20",
    rating: 4.5,
    price: "$165–$186",
    description: "The Nature DX with ED glass, which cuts the purple fringing you get on a dark bird against bright sky.",
    covers: [],
    altGroup: "birding-binoculars",
    pets: [],
  },
  {
    slug: "binoculars-nikon-monarch-m5-8x42",
    product: "Nikon Monarch M5 8x42 Binoculars",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B09GV5J647?tag=beastlyfacts-20",
    rating: 4.5,
    price: "$227–$290",
    description: "ED glass, dielectric prism coatings, long eye relief for glasses wearers, 22 oz. The pair most birders stop upgrading after.",
    covers: [],
    altGroup: "birding-binoculars",
    pets: [],
  },
  {
    slug: "binocular-harness-vortex-strap",
    product: "Vortex Binocular Harness Strap",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B000BH24JM?tag=beastlyfacts-20",
    rating: 4.7,
    price: "$24–$32",
    description: "Shoulder harness that takes binocular weight off the neck and stops them swinging on the walk in. The cheapest comfort upgrade in birding.",
    covers: [],
    pets: [],
  },
  {
    slug: "field-guide-sibley-eastern-north-america",
    product: "The Sibley Field Guide to Birds of Eastern North America (2nd Edition)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/0307957918?tag=beastlyfacts-20",
    rating: 4.7,
    price: "$13–$22",
    description: "650 species east of the Rockies, painted rather than photographed so plumages can be compared side by side. The regional volume, sized to carry.",
    covers: [],
    altGroup: "sibley-regional-field-guide",
    pets: [],
  },
  {
    slug: "field-guide-sibley-western-north-america",
    product: "Sibley Birds West: Field Guide to Birds of Western North America (2nd Edition)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/0307957926?tag=beastlyfacts-20",
    rating: 4.7,
    price: "$16–$24",
    description: "703 species west of the Rockies, the companion volume to Sibley East. Buy the side of the Rockies you live on.",
    covers: [],
    altGroup: "sibley-regional-field-guide",
    pets: [],
  },
  {
    slug: "bird-feeder-squirrel-buster-plus",
    product: "Brome Squirrel Buster Plus Squirrel-Proof Bird Feeder",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0007LQ3RQ?tag=beastlyfacts-20",
    rating: 4.7,
    price: "$108–$130",
    description: "A squirrel's weight pulls a shroud down over the ports. 5.1 lb capacity, six ports, chew-proof shell, and it comes apart by hand for cleaning.",
    covers: [],
    pets: [],
  },
  {
    slug: "bird-seed-wagners-black-oil-sunflower-25lb",
    product: "Wagner's Black Oil Sunflower Wild Bird Food (25 lb)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B00O2T24OA?tag=beastlyfacts-20",
    rating: 4.7,
    price: "$42–$52",
    description: "Thin-shelled, high-fat sunflower. More feeder species eat this than any other single seed, which is why it beats a cheap mixed blend.",
    covers: [],
    pets: [],
  },
  {
    slug: "window-markers-feather-friendly-diy",
    product: "Feather Friendly Bird Collision Deterrent Markers (Small-scale DIY roll)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0CZM9D29V?tag=beastlyfacts-20",
    rating: 3.9,
    price: "$30–$62",
    description: "Quarter-inch exterior dots pre-spaced at two inches, which is the spacing that actually stops strikes. Applying them is fiddly and the reviews say so.",
    covers: [],
    pets: [],
  },
  {
    slug: "heated-birdbath-api-970",
    product: "API 970 Heated Bird Bath with Metal Stand (20 inch)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0006HRQNQ?tag=beastlyfacts-20",
    rating: 4.1,
    price: "$135–$155",
    description: "Thermostat-controlled basin with an enclosed element, to keep water open through a freeze. In winter, open water is scarcer than food.",
    covers: [],
    pets: [],
  },
  {
    slug: "hummingbird-feeder-aspects-hummzinger-highview",
    product: "Aspects HummZinger HighView Hummingbird Feeder (12 oz)",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B003XL7WZO?tag=beastlyfacts-20",
    rating: 4.5,
    price: "$29–$36",
    description: "Saucer feeder with a built-in ant moat that twists apart to clean in seconds. Nectar spoils fast, so cleanability is the spec that decides this one.",
    covers: [],
    pets: [],
  },
  {
    slug: "smart-bird-feeder-bird-buddy-pro-solar",
    product: "Bird Buddy Pro Solar Smart Bird Feeder with Camera",
    category: "Birdwatching & Wild Birds",
    retailer: "amazon",
    link: "https://www.amazon.com/dp/B0DHY6B9GY?tag=beastlyfacts-20",
    rating: 4.1,
    price: "$240–$300",
    description: "Camera feeder with a solar roof and automatic species ID. Treat the IDs as a first guess on lookalikes, and the feeder as an add-on rather than optics.",
    covers: [],
    pets: [],
  },
