  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Size by subspecies", value: "ReptiFiles, working from Markel's reference figures, gives Pueblans 28 to 36 inches, Easterns 36 to 45, and Hondurans and Sinaloans 40 to 48.", source: "milk-snake-tank-setup-guide" },
    ...
    emergencyCard: {
      ...
      callNow: [
        ...
        "Cheesy or yellowish material around the gums",
      ],
    ...
    routes: [
      ...
      { slug: "milk-snake-vs-corn-snake-guide", line: "Where the two classic beginner colubrids actually differ: range, subspecies count, mimicry, and feeding reliability." },
    ],
    buyList: [
