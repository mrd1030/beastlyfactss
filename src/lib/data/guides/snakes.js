export const snakeGuides = [
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Security", value: "Every heat source must run through a thermostat, with zero exceptions. An unregulated heat mat can get hot enough to cause a serious burn. Corn snakes are notorious escape artists, so confirm the enclosure locks or latches securely before your snake ever goes in.", source: "corn-snake-tank-setup-guide" },
        { label: "Temperatures", value: "Warm/basking side 85 to 90°F, cool side 72 to 82°F, nighttime room temperature, up to 75°F.", source: "corn-snake-tank-setup-guide" },
        { label: "Humidity", value: "Sources disagree, some recommend 65 to 75%, others cite 40 to 60% as sufficient, raised to around 70% during shedding. Either range works in practice; what matters more is a dedicated humid hide with damp sphagnum moss during shed cycles.", source: "corn-snake-tank-setup-guide" },
        { label: "UVB", value: "Not required. Corn snakes have been kept for decades without it, though it is increasingly seen as beneficial long term. If you add one, a 5.0 or 6% T5 HO bulb over the warm side, for a maximum basking UVI of 2.0 to 3.0, replaced yearly.", source: "corn-snake-tank-setup-guide" },
        { label: "Substrate", value: "Aspen shavings are the classic choice. Keep it at least 3 inches deep to allow natural burrowing behavior. Avoid pine or cedar entirely, both can damage a reptile's airways.", source: "corn-snake-tank-setup-guide" },
    ...
    faqs: [
      ...
      { q: "What humidity level does a corn snake need?", a: "Sources disagree, some recommend 65-75%, others cite 40-60% as sufficient, raised to around 70% during shedding. Either range works in practice, what matters more is consistency and a dedicated humid hide with damp sphagnum moss during shed cycles." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How often should I feed a garter snake?", a: "Frequency depends on what the snake eats. Earthworm-heavy diets need feeding roughly twice a week, fish-heavy diets about every 5 to 7 days, and mouse-eaters about once a week as adults, with juveniles fed more often, every other day to every few days. Two smaller items can substitute for one larger one." },
