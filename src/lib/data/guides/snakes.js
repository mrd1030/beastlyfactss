export const snakeGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Hatchlings every 5-7 days, juveniles at 6-18 months every 7-10, adults every 10-14, on prey the width of the snake's thickest point, a medium rat for most adults.", source: "ball-python-feeding-guide" },
        ...
        { label: "Quarantine", value: "3 to 6 months. Mites show within weeks; inclusion body disease can sit silent for months to years, and pythons are one of the two groups it affects.", source: "reptile-quarantine-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Hatchlings and juveniles every 5 to 7 days, adults every 10 to 14, on frozen-thawed rodents about the width of the snake at its thickest. Never live, which injures a snake that does not strike cleanly.", source: "california-kingsnake-tank-setup-guide" },
        ...
        { label: "Floor space and cover", value: "An enclosure longer than the snake is the one change with a preference test behind it, and cork tubes, leaf litter over aspen, and clutter are what make the snake cross it. A braced branch adds a level.", source: "california-kingsnake-enrichment-guide" },
        ...
        { label: "Lifespan", value: "20 years or more with good care.", source: "california-kingsnake-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "The thiaminase problem", value: "Goldfish and rosy red minnows break down thiamine. Feed thiaminase-free fish like tilapia, salmon, and silversides, frozen and thawed, since bait fish carry parasites, and add B1 if fish exceed a quarter of the diet.", source: "garter-snake-feeding-guide" },
        { label: "Expect musk", value: "A threatened garter musks rather than strikes. Unpleasant, harmless, and it fades with calm repeated handling. Give a new snake one to two weeks to settle and eat first.", source: "garter-snake-handling-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Where to feed", value: "In a separate container. Enthusiastic, messy eaters that swallow substrate with their food.", source: "hognose-snake-health-issues-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Juveniles every 7 to 10 days, adults every 10 to 14, on frozen-thawed rodents no more than 1.5 times the snake's width, or roughly 10% of its body weight.", source: "milk-snake-tank-setup-guide" },
        ...
        { label: "Cover, not a smaller box", value: "Cork tubes and flats, leaf litter over deep aspen, and planting dense enough to break sightlines, so it can cross the enclosure without being exposed. Two hides is the start, not the finish.", source: "milk-snake-enrichment-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Enclosure", value: "A 10 to 15 gallon terrarium for a young snake, 20 to 30 gallons for an adult of 24 to 36 inches, and 36x18x18 inches the higher-end recommendation. Housed individually, with a snug hide, since it lives in rock crevices.", source: "rosy-boa-tank-setup-guide" },
        ...
        { label: "Diet", value: "Frozen-thawed mice for life, pinkies or fuzzies up to small or medium adults, offered with tongs, never live.", source: "rosy-boa-feeding-guide" },
        ...
        { label: "Lifespan", value: "20 to 30 years typical, the captive average nearer 18 to 22.", source: "rosy-boa-cost-guide" },
