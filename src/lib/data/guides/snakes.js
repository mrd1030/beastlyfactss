  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Quarantine", value: "A new snake is quarantined for 3 to 6 months. Mites usually show themselves within weeks, and a veterinary fecal exam is genuinely worth prioritizing for this species rather than treating as optional.", source: "reptile-quarantine-guide" },
        { label: "Enclosure", value: "A single adult does well in a 36x18x18 inch enclosure or an equivalent 40-gallon breeder tank as the minimum, a size cited consistently across care sheets. A mated pair does better with more room, with a 55-gallon equivalent a common recommendation. Garter snakes are active and inquisitive, so floor space beyond the bare minimum genuinely gets used.", source: "garter-snake-tank-setup-guide" },
        ...
        { label: "Temperature", value: "Basking or warm side 85 to 90°F, with some sources going up to 95°F for reliable digestion, so treat the lower end as a floor rather than a ceiling. Cool side 70 to 75°F, and nights as low as 64°F are tolerated. Whatever heat source you choose runs through a thermostat, the part with zero exceptions.", source: "garter-snake-tank-setup-guide" },
        ...
        { label: "Why a basin, really", value: "Many garter snake populations are semi-aquatic and hunt in water, so a container large enough to swim in rather than merely soak is a genuine enrichment item here in a way it is not for most snakes.", source: "garter-snake-enrichment-guide" },
    ...
    faqs: [
      { q: "Why do so many garter snakes refuse mice?", a: "Keepers and researchers who work with the genus commonly describe individuals falling into rough groups: fish and amphibian specialists, worm and slug specialists, and true generalists. A fish or amphibian specialist may refuse mice entirely for its entire life, even ones scented with fish smell, and there's no reliable way to know in advance which kind you have." },
      { q: "What is the thiaminase problem?", a: "Thiaminase is an enzyme, concentrated mainly in the guts and viscera of certain fish, that breaks thiamine apart into components the body can't use. Goldfish and rosy red minnows, two of the most commonly available feeder fish, are notably high in it, and the veterinary reference literature calls out garter and water snakes by name as the group most likely to be affected." },
      { q: "Why does a garter snake need a water feature it can swim in?", a: "Garter snakes are semi-aquatic, proficient swimmers in the wild that hunt fish and amphibians in and around water, and that translates directly into captivity: they use a water feature for soaking, drinking, and often defecating, not just the occasional sip. Size the container so the snake can fully submerge." },
    ],
  },
  {
    id: "hognose-snake",
