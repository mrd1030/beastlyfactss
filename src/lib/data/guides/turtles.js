export const turtleGuides = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How long do red-eared sliders live, and why does that matter for budgeting?", a: "20 to 30 years is the consensus range, and the documented captive record is 41.3 years. Budget for the adult from day one: the palm-sized hatchling becomes a turtle that needs a 75 to 100-plus gallon home, and it keeps needing one for decades." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Quarantine", value: "Six months minimum, apart from any other chelonian, with lab testing: a herpesvirus carrier can look healthy for months, so two or three weeks is not enough.", source: "chelonian-herpesvirus-quarantine-guide" },
        ...
        { label: "UVB", value: "Essential indoors: a T5 HO UVB fixture, replaced every 12 months, prevents the shell and bone disease on the emergency card. Outdoors, sunlight does it better and free.", source: "sulcata-tortoise-tank-setup-guide" },
