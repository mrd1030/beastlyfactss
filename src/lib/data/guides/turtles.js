  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "UVB", value: "Daily UVB, run about 12 hours a day. Most detailed care sheets recommend a T5 HO fixture in the Arcadia 12% or Zoo Med ReptiSun 10.0 range; some UVB researchers place this forest-edge species in a lower Ferguson zone and recommend a more moderate Arcadia Forest 6% instead. Either can work, and what matters most is real shade the tortoise can retreat into to regulate its own exposure.", source: "red-footed-tortoise-tank-setup-guide" },
        ...
        { label: "Diet", value: "Roughly 90% plant matter and 10% animal matter. PetMD's tropical tortoise care sheet suggests about 70% leafy greens, 20% other vegetables, and 10% fruit; other detailed care sheets put fresh fruit closer to 15% with a bit less protein. Leafy greens and vegetables are the everyday base.", source: "red-footed-tortoise-feeding-guide" },
        ...
        { label: "Lifespan", value: "50 to 70 years or more is commonly cited across care sheets, with some sources putting exceptionally well-kept individuals close to 90. That is a multi-decade, potentially generational commitment.", source: "red-footed-tortoise-cost-guide" },
        { label: "Hygiene", value: "Wash hands with soap and running water immediately after any contact, and never clean an enclosure, water dish, or equipment in a kitchen sink or a bathtub people use.", source: "reptile-salmonella-hygiene-guide" },
      ],
    },
    emergencyCard: {
      ...
      vetLine: "Chronically dry, cool conditions are what put this species at risk, the exact opposite husbandry mistake from the one that threatens a Russian or sulcata tortoise, so raise humidity and warmth while you arrange the appointment. Find a vet with chelonian experience specifically rather than a general exotics practice.",
    },
    routes: [
      { slug: "red-footed-tortoise-cost-guide", line: "$150 to $900 for the tortoise, the $500 to $950 setup, roughly $650 to $850 a year, and the humidity equipment a Russian tortoise owner never buys." },
      { slug: "red-footed-tortoise-tank-setup-guide", line: "The 18 to 24 square foot floor, why an open-topped table fails here, 70 to 80% humidity and how to actually hold it, damp substrate, and the UVB strength two camps disagree on." },
      { slug: "red-footed-tortoise-feeding-guide", line: "The 90/10 split and how care sheets divide the plant side, why fruit gets more room here than with any other pet tortoise, and why skipping animal protein cripples this species." },
    ...
    faqs: [
      ...
      { q: "How long do red-footed tortoises live, and why does that matter for budgeting?", a: "50 to 70 years or more is commonly cited, with some care sheets putting well-kept individuals near 90. Like any pet tortoise, that's a commitment that can outlast the owner who bought it, worth planning for as seriously as the upfront cost." },
    ],
  },
  {
    id: "russian-tortoise",
