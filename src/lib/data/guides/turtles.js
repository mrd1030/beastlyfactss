export const turtleGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Handling", value: "Both hands under the full body, short sessions, and never dropped, shaken, or flipped, which interferes with breathing.", source: "box-turtle-handling-guide" },
        ...
        { label: "Cold stress", value: "Open-mouth breathing, wheezing or clicking, mucus at the nose or mouth, or a turtle still limp once warm again: stop managing it yourself and call a vet.", source: "reptile-emergency-plan-guide" },
      ],
    },
    emergencyCard: {
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Handling", value: "Scooped from underneath with the full body supported, never from above. A drop can kill a turtle this size.", source: "red-eared-slider-handling-guide" },
    ...
    emergencyCard: {
      ...
      vetLine: "A reptile vet. Respiratory infection progresses quickly, and an ear abscess almost always needs surgical drainage and antibiotics. Annual or semi-annual exams catch most of this early.",
    },
    routes: [
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$150 to $300 for a captive-bred hatchling, $350 to $600 for a started juvenile, $550 to $900 for an adult. Setup $500 to $950, then $650 to $850 a year. A checkup is $75 to $100, with a chelonian-experienced vet.", source: "red-footed-tortoise-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Outdoor space", value: "80 to 100 square feet per tortoise, ideally several hundred, arriving within a few years of a hatchling coming home, since they grow fast through the first 5 to 10 years. No outdoor space in that window means this is the wrong species.", source: "sulcata-tortoise-tank-setup-guide" },
        { label: "Fencing", value: "Escape-proof, and it goes down as well as up: a sulcata that wants to leave digs under it.", source: "sulcata-tortoise-enrichment-guide" },
        ...
        { label: "UVB", value: "Essential for any indoor housing: a T5 HO UVB fixture. It is the prevention for the shell and bone disease on the emergency card.", source: "sulcata-tortoise-tank-setup-guide" },
        ...
        { label: "Humidity, by age", value: "Adults dry and well ventilated. Hatchlings and juveniles need humid hides at roughly 70% for shell growth, the way wild sulcatas use humid burrows in a dry habitat.", source: "sulcata-tortoise-tank-setup-guide" },
        ...
        { label: "Diet", value: "Grass and grass hay at 75 to 80% or more, at every age. No animal protein, ever, which causes the kidney and liver damage behind many premature deaths, and fruit only as a rare tiny treat. A sulcata that stops eating is usually too cold.", source: "sulcata-tortoise-feeding-guide" },
        ...
        { label: "Pyramiding", value: "Permanent once it happens. Humid hides while growing and a properly paced diet are the defense, whichever of the two studies is right about the cause.", source: "sulcata-tortoise-health-issues-guide" },
        { label: "Handling", value: "A juvenile low to the ground, never flipped: it pushes off hard and a short fall cracks the shell. An adult of 80 to 110 pounds, a male to 200, is not lifted; interaction happens at ground level. Two males never together.", source: "sulcata-tortoise-handling-guide" },
        { label: "Budget", value: "A few hundred dollars for the indoor juvenile setup, the cheap phase. A basic outdoor enclosure reaches $1,000 and a heated shelter adds $1,000 or more.", source: "sulcata-tortoise-cost-guide" },
