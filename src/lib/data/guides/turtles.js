  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Tank size", value: "Roughly 10 gallons of water per inch of shell length is the rule of thumb VCA Animal Hospitals gives for housing aquatic turtles. In practice, that means a practical adult minimum of 75 to 100 gallons for one turtle, with many experienced keepers recommending 100 to 125 gallons or more for better water quality and swimming room.", source: "red-eared-slider-tank-setup-guide" },
        { label: "Water temperature", value: "Water temperature should sit at 72 to 82°F, the range LafeberVet's aquatic turtle care sheet gives, though stability matters more than hitting an exact number.", source: "red-eared-slider-tank-setup-guide" },
        ...
        { label: "Water depth", value: "Water depth should be at least 1.5 to 2 times the shell length, the figure VCA Animal Hospitals gives, enough for the turtle to right itself if flipped, but not so deep that a weak or sick animal struggles to reach the surface.", source: "red-eared-slider-tank-setup-guide" },
        ...
        { label: "Water changes", value: "A filter is not a substitute for changing the water: VCA Animal Hospitals puts a floor under it, saying the tank water must be changed at least once weekly, or more frequently if it becomes dirty.", source: "red-eared-slider-tank-setup-guide" },
        ...
        { label: "Cold water floor", value: "Water below 65 to 70°F (18 to 21°C) overnight, per VCA, is when bacterial infection risk and appetite loss start.", source: "reptile-emergency-plan-guide" },
