  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Temperature", value: "73 to 84°F is the range Seriously Fish gives for this species, and Practical Fishkeeping puts general care closer to 77 to 82°F. It notes cardinal tetra tolerates water reaching 86°F, against roughly 77°F for neon tetra, so cardinal is the better fit for a warmer community tank.", source: "cardinal-tetra-tank-setup-guide" },
        ...
        { label: "Filtration", value: "Keep the flow gentle. This species comes from slow-moving forest streams, and Seriously Fish describes their natural habitat as full of fallen branches and leaf litter rather than open current. A sponge filter is a common, effective choice.", source: "cardinal-tetra-tank-setup-guide" },
        ...
        { label: "Staple diet", value: "A high-quality micro-pellet or crushed flake as the staple, supplemented with live or frozen bloodworms, mosquito larvae, and daphnia. Seriously Fish also lists Moina as a good live option.", source: "cardinal-tetra-feeding-guide" },
        ...
        { label: "Feeding schedule", value: "Twice a day is the practical standard, offering only what the school finishes in a couple of minutes. Practical Fishkeeping notes this species feeds almost constantly in the wild, so some keepers split that into three or four smaller feedings a day instead.", source: "cardinal-tetra-feeding-guide" },
        ...
        { label: "Neon tetra disease", value: "Named after neon tetra specifically, but the Merck Veterinary Manual documents the parasite affecting tetras broadly, along with angelfish, rasboras, barbs, and zebrafish, so cardinal tetra falls within that group. Caused by a microsporidian parasite, Pleistophora hyphessobryconis, that invades muscle tissue.", source: "cardinal-tetra-health-issues-guide" },
        { label: "Quarantine", value: "Aquarium Co-Op notes that quarantining any new fish for a full 30 days before introduction is the most effective way to keep ich out of an established tank in the first place.", source: "cardinal-tetra-health-issues-guide" },
        ...
        { label: "Lifespan", value: "About five years in captivity under good, stable conditions, and Animal Diversity Web notes individuals may reach ten. In the wild it is close to an annual fish: the shallow dry-season pools shrink and strand huge numbers, and most don't see a second year.", source: "cardinal-tetra-cost-guide" },
