  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Adults: sources give a real range rather than one number, once or twice a day, one to three times daily, or two to three times daily depending on where you look. Every source agrees on the same portion rule regardless of frequency: feed only what's fully cleared within about 1 to 2 minutes.", source: "guppy-feeding-guide" },
        { label: "Feeding fry and juveniles", value: "Fry, newborn to roughly 2 to 4 weeks, take the highest feeding frequency of any stage: sources range from 3 to 5 times a day up to every 2 to 3 hours in the earliest days. Juveniles, roughly 1 to 3 to 4 months, get around 3 to 4 meals a day.", source: "guppy-feeding-guide" },
        ...
        { label: "Quarantine", value: "At least 30 days in a bare hospital tank before joining others, per the Merck Veterinary Manual, which puts the full range at 30 to 60 days for a fish you want to be genuinely sure about. Thirty days is the floor, not the target, since some parasites and infections take that long to show themselves.", source: "fish-quarantine-and-treatment-guide" },
    ...
    faqs: [
      ...
      { q: "How often should I feed my guppy?", a: "Adults land somewhere between once and three times a day depending on the source, there's no single agreed number. What every source agrees on is the portion rule, only offer what's fully cleared in about 1 to 2 minutes. Overfeeding, not underfeeding, is the more common real mistake, guppies beg regardless of actual hunger." },
    ],
  },
  {
    id: "koi",
