export const fishGuides = [
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Ich", value: "White spots: raise the tank slowly to 86°F with an air stone and hold it two weeks. That is a treatment ceiling for the course only, above the 76 to 82°F a betta lives at. Or a tablespoon of aquarium salt per 5 gallons. Quarantine 30 days after.", source: "aquarium-ich-treatment-guide" },
  ...
  },
  {
    ...
    emergencyCard: {
      ...
      callNow: [
        ...
        "Small, pinhead-sized white spots across the body and fins: ich, treated by warming only to 80°F with strong aeration and a copper-free medication, never salt or copper",
    ...
    faqs: [
      { q: "What size tank does a bristlenose pleco need?", a: "20 gallons is the practical floor for one adult, though 29 or more holds up better long term, since this fish produces a lot of waste for its size. Size up again for each extra bristlenose." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "About $3 a fish, roughly $25 to $30 for the school, and most first setups land around $100 to $250. Vet care does not apply; water quality and over-the-counter treatment are the whole of it.", source: "cardinal-tetra-cost-guide" },
    ...
    emergencyCard: {
      ...
      heading: "Test the water first, then act on these today. Aquatic vets are rare, so nearly all of this is handled at home.",
      callNow: [
        "Small white spots like grains of salt, flashing against decor, rapid breathing: ich, treated with medication, or with heat raised slowly to 86°F and no higher, since this species dies near 33.7°C",
    ...
    routes: [
      { slug: "cardinal-tetra-cost-guide", line: "About $3 a fish, the $65 to $230 setup, and the Rio Negro fishery behind why this one prices above a neon." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Surface access", value: "Clear access to the surface: gulping air is normal breathing. An occasional dash up is fine; constant dashes mean the water is short of oxygen or fouled.", source: "corydoras-catfish-enrichment-guide" },
        { label: "Quarantine", value: "At least 30 days in a bare tank before new cories join; 30 to 60 for a fish worth being sure of.", source: "fish-quarantine-and-treatment-guide" },
        { label: "Not algae eaters", value: "The cleanup-crew reputation is wrong. Cories pick leftovers off the bottom and need sinking food of their own; algae and scraps will not keep them alive.", source: "corydoras-catfish-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Water changes", value: "The routine that defines a working discus tank: 10 to 25% every week as the baseline, more whenever nitrate nears 20 ppm unplanted or 40 ppm planted.", source: "discus-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Juveniles get 2 to 3 small feedings a day. Adults get one small meal a day, only what's eaten in under two minutes; the same ration can be split into two smaller meals.", source: "goldfish-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Adult size", value: "Typically 24 to 25 inches (about 60 cm), up to 3 feet (90 cm) in a spacious pond." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Cycle first", value: "4 to 6 weeks fishless, less with bottled bacteria, and a conditioner on every bucket of tap water. Ammonia and chlorine are both recognized shimmy triggers.", source: "molly-tank-setup-guide" },
        { label: "Water changes", value: "25 to 30% weekly from the substrate, with conditioned water at tank temperature. Test nitrate first: under 20 ppm the routine is right, past 40 ppm the next change is 50%.", source: "aquarium-water-changes-guide" },
  ...
  },
  {
    ...
    faqs: [
      { q: "How can you tell a male neon tetra from a female?", a: "Only once they're adults. Females are rounder-bodied and a little larger, and the fuller belly makes the blue stripe look slightly bent. Males stay slim with a straight stripe." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Cycle first", value: "4 to 6 weeks fishless, less with bottled bacteria. A platy survives an uncycled tank, which is exactly why this step gets skipped, and it does so while breathing ammonia.", source: "platy-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Water chemistry", value: "pH 7.0 to 8.4 in moderately hard to hard water, roughly 10 to 25 dGH. Soft tap water gets crushed coral or a buffering product.", source: "swordtail-tank-setup-guide" },
        { label: "Temperature", value: "75 to 79°F is the steady target inside a workable 65 to 82°F. Avoid sudden swings.", source: "swordtail-tank-setup-guide" },
    ...
    buyList: [
      ...
      "One male and three or four females, or a single-sex group",
      "Liquid water test kit",
      "Water conditioner",
