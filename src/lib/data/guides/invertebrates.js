export const invertebrateGuides = [
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Grazing surface and group size", value: "Dense live plants or moss, driftwood and leaf litter. Cherry shrimp are more active, more visible and more confident in a colony, and ten or more is a sensible starting point in a tank of reasonable size.", source: "cherry-shrimp-enrichment-guide" },
        { label: "Feeding", value: "A piece of food no larger than a pea, or a quarter of a small wafer, is enough for a colony of 10 to 20 shrimp.", source: "cherry-shrimp-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Recovery first", value: "Acclimate slowly, then give them a quiet, stable, planted tank and low expectations for the first two weeks.", source: "ghost-shrimp-enrichment-guide" },
        ...
        { label: "Molting", value: "Most failures trace back to water parameters and diet, specifically inadequate calcium and general hardness leaving a new shell unable to harden. The most serious version is the white ring of death, a solid band where the shell should split cleanly at the head, trapping the animal between old and new exoskeleton.", source: "ghost-shrimp-health-issues-guide" },
        { label: "Feeding", value: "A small amount every day or two is plenty for a modestly stocked tank, since ghost shrimp scavenge a meaningful share of their food on their own. No dedicated supplement is required.", source: "ghost-shrimp-feeding-guide" },
        { label: "Not an algae crew", value: "Some, but they're better described as an all-purpose detritivore than a dedicated algae specialist.", source: "ghost-shrimp-feeding-guide" },
        { label: "They eat each other", value: "A real and documented risk, not a rare exception. Dense hiding cover and generous, consistent feeding both measurably reduce how often it happens.", source: "ghost-shrimp-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Food", value: "The substrate is most of the diet. Fresh produce is a supplement on top of that: cucumber, carrot, sweet potato and leafy greens, plus small amounts of fruit such as apple, banana, melon or mango, offered every two to three days and taken back out before it molds.", source: "giant-millipede-tank-setup-guide" },
        { label: "Calcium", value: "Stays in permanently instead of going in on a schedule, a cuttlebone or powdered calcium carbonate left on the substrate for the animal to gnaw when it needs it.", source: "giant-millipede-tank-setup-guide" },
        ...
        { label: "Handling", value: "Handle over a soft surface close to the ground, support the full body, and never grab from above, let the millipede walk onto your hand instead. Millipedes molt underground, a buried one must not be disturbed, and a molt may take several weeks.", source: "giant-millipede-handling-guide" },
        { label: "The secretion", value: "The fluid carries benzoquinones, mild irritants that can sting skin and eyes in someone sensitive and leave a stain. Keep it away from your eyes and mouth, and wash your hands thoroughly after a session.", source: "giant-millipede-handling-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      intro: "The numbers a new owner needs in the first week, each taken from the article that explains it.",
      rows: [
        { label: "Budget", value: "Captive-bred spiderlings run $15 to $25. Juvenile or sub-adult females, generally more prized than males since they live considerably longer, run $25 to $60. Roughly $112 to $150, and the enclosure is most of it at $60 to $70. Roughly $5 to $15 a month.", source: "jumping-spider-cost-guide" },
        ...
        { label: "Retained molt", value: "A spider that gets stuck in its old exoskeleton during a molt can lose limbs or die. This is caused by insufficient humidity in the lead-up to molting.", source: "jumping-spider-health-issues-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Enclosure size", value: "Length and width should each be at least twice the mantis's body length, and height at least three times its length. A reasonable adult enclosure runs around 8 inches long, 8 inches wide, and 12 inches tall as a minimum.", source: "praying-mantis-tank-setup-guide" },
        { label: "The measurement that decides a molt", value: "The drop from the top of the perch to the floor, which wants to be at least four times the mantis's length.", source: "praying-mantis-tank-setup-guide" },
        { label: "What the ceiling has to be", value: "Something the mantis can grip securely upside down for hours: mesh, screen or a rough surface. Keep the center of the upper enclosure clear.", source: "praying-mantis-enrichment-guide" },
        { label: "One per enclosure", value: "They are cannibalistic and will eat each other at any size difference and often at none.", source: "praying-mantis-enrichment-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Food", value: "Leaves, and that is the entire diet. Almost every commonly kept stick insect eats washed bramble, the blackberry stems that grow in any hedgerow, and it goes species by species from there: Indian stick insects also take privet and ivy, while rose, hawthorn, oak and eucalyptus each suit different species.", source: "stick-insect-tank-setup-guide" },
        { label: "Keeping the leaves alive", value: "Block the opening of the water container so nothing can fall in, because a nymph drowned in a jar of stems is the routine avoidable loss in this hobby.", source: "stick-insect-tank-setup-guide" },
        ...
        { label: "Handling", value: "Gently grasp the body or thorax if you need to move a stick insect, and never grab a leg.", source: "stick-insect-handling-guide" },
