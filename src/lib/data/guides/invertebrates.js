export const invertebrateGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Water chemistry", value: "pH 6.0 to 7.5, KH 2 to 8, and GH 5 to 15. Too little hardness and a new shell cannot harden; too much and the old one is too rigid to break out of. A conditioner on every drop of tap water.", source: "amano-shrimp-tank-setup-guide" },
