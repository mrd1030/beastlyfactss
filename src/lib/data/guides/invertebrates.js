export const invertebrateGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "How many", value: "One shrimp per 2 gallons, so five in a 10-gallon. That is the only density figure any of the sources states, and it is the one to use. Their bioload is low enough that a tank already fighting an algae outbreak can carry more without a water quality problem, but more shrimp in the same algae only means the supply runs out sooner.", source: "amano-shrimp-tank-setup-guide" },
        ...
        { label: "Lifespan", value: "2 to 3 years is the commonly cited range in captivity, with shrimp kept toward the cooler end of their comfortable temperature range sometimes living longer still.", source: "amano-shrimp-cost-guide" },
      ],
    },
    emergencyCard: {
      ...
      callNow: [
        ...
        "Shrimp that stop responding to food they would normally find, which is what sublethal copper exposure looks like before anything dies",
      ],
    ...
    routes: [
      ...
      { slug: "amano-shrimp-tank-setup-guide", line: "The 10-gallon minimum and two stocking densities that serve different jobs, general hardness as a molting input, a sponge filter for intake safety rather than calm water, and the lid." },
    ...
    faqs: [
      { q: "Why do my amano shrimp eggs never hatch?", a: "A female amano shrimp mates and carries fertilized eggs under her abdomen completely normally, and those eggs do hatch into free-swimming larvae right on schedule. What doesn't happen is the next step: those larvae need to reach brackish or marine water within their earliest stages to survive, something a standard freshwater display simply can't provide." },
      { q: "Are amano shrimp really that sensitive to copper?", a: "Shrimp carry copper-based hemocyanin in their blood rather than iron-based hemoglobin, the molecule that carries oxygen through their body. That's exactly why free copper is so disproportionately dangerous to them: it interferes with the same metal their blood depends on to function at all, in a way vertebrate blood chemistry simply isn't exposed to." },
      { q: "Do amano shrimp eat every kind of algae?", a: "No. They take hair, thread and black beard algae readily, which is more than most cleanup crew members manage, but they won't get at the tougher types like green spot algae, the hard adhered spots on glass and slow-growing leaves. Cyanobacteria isn't a true algae at all and needs treating as the bacterial bloom it is." },
    ],
  },
  {
    id: "cherry-shrimp",
