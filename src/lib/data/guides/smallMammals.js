export const smallMammalGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Dust bath", value: "Chinchilla dust, never sand or water, 2 to 3 times a week (some owners go daily), for up to 15 minutes at a time, using 1 to 2 inches of dust in a shallow container. Remove the container afterward.", source: "chinchilla-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$10 to $50 per degu and you need two. Equipment roughly $375 to $520, most of it a tall multi-level cage at $280 to $360, and an exotic vet check with dental at $80 to $160 a year.", source: "degu-cost-guide" },
    ...
    buyList: [
      ...
      "Solid exercise wheel, at least 12 inches across",
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "The ratio that matters", value: "Calcium to phosphorus roughly 2:1. Nuts and seeds at wild-forager frequency produce calcium problems fast. No chocolate, dairy, candy, or anything processed or salted.", source: "flying-squirrel-feeding-guide" },
        { label: "Water", value: "Fresh water available at all times, checked daily.", source: "flying-squirrel-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      intro: "The numbers a new owner needs in the first week, each from the article it links to. Rows with no link come from the encyclopedia.",
      rows: [
        { label: "Never just one", value: "A same-sex pair or sibling group; introductions between unfamiliar adults frequently fail. Diurnal and crepuscular, so awake when you are, unlike a hamster.", source: "gerbil-handling-guide" },
        ...
        { label: "The burrow", value: "6 to 10 inches of digging depth at minimum, in aspen and paper bedding with some hay worked in so tunnels hold, plus a buried tunnel that leads to a chamber. No cedar, aromatic pine, scented bedding, or fluffy cotton nesting material.", source: "gerbil-tank-setup-guide" },
        ...
        { label: "Nails", value: "Digging and running wear them down, so there is no trim schedule. Check for overgrowth in an older or less active gerbil.", source: "small-mammal-grooming-nails-molting-guide" },
  ...
  },
  {
    ...
    emergencyCard: {
      ...
      callNow: [
        ...
        "Chewing at its own skin or tail, most common in a lonely or stressed glider, particularly an intact solitary male",
      ],
      soon: [
