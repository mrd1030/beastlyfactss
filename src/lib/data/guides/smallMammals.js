  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Handling", value: "Both hands scooping, one under the chest and one under the hindquarters, held close. Never by the tail: the skin shears away. A few days to settle first, and rats are the pocket pet least likely to bite.", source: "rat-handling-guide" },
