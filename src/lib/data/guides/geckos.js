export const geckoGuides = [
  ...
  },
  {
    ...
    firstWeek: {
      intro: "The numbers a new owner needs in the first week, each taken from the article that explains it.",
      rows: [
        { label: "Buy captive-bred", value: "Wild-caught individuals consistently live shorter lives than captive-bred ones, and internal parasites are genuinely common in wild-caught imports specifically. That gap is one more reason to pay the captive-bred premium.", source: "leaf-tailed-gecko-cost-guide" },
        ...
        { label: "Feeding", value: "Juveniles eat daily and adults every other day, offered in the evening when these nocturnal geckos are naturally active, and the portion is as much as the gecko will take in one night. Crickets, dubia roaches and isopods cover most of it, with pygmy species needing fruit flies and pinhead crickets instead.", source: "leaf-tailed-gecko-tank-setup-guide" },
        { label: "Prey size", value: "No larger than the space between the gecko's eyes. Remove anything uneaten before morning, since live insects loose in the enclosure overnight disturb a resting gecko.", source: "leaf-tailed-gecko-tank-setup-guide" },
        { label: "Supplements", value: "Gut-load feeders for 24 to 48 hours, then dust them. A single all-in-one calcium-plus-vitamin powder lightly dusted on every feeder is the simplest approach and the one most commonly recommended for this genus.", source: "leaf-tailed-gecko-tank-setup-guide" },
