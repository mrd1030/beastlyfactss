  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Lighting and water", value: "Low-output UVB for a UVI of 1.0 to 2.0 at the top branch, about 13 hours of light in summer and 11 in winter, never basking-strength. Tap water, not distilled, for misting and drinking, for the minerals.", source: "leaf-tailed-gecko-tank-setup-guide" },
    ...
    buyList: [
      ...
      "Low-output UVB for a UVI of 1.0 to 2.0, never a basking-style bulb",
