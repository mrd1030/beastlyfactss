export const geckoGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Enclosure", value: "A 20-gallon long is the minimum for one adult, and a 36x18x16 inch (40-gallon breeder) is meaningfully better.", source: "african-fat-tail-tank-setup-guide" },
        { label: "Heat", value: "A heat mat on a thermostat. Aim for 88 to 92°F on the warm side, 75 to 80°F on the cool side, and a night drop to 70 to 75°F.", source: "african-fat-tail-tank-setup-guide" },
        { label: "Humidity", value: "Ambient around 50 to 70% works, and a permanent humid hide at 70 to 80% is the piece that prevents shedding problems.", source: "african-fat-tail-tank-setup-guide" },
        { label: "Substrate", value: "For healthy adults, a naturalistic sandy-soil mix: roughly 70% topsoil to 30% play sand, or coconut fiber with reptile sand, at least 4 inches deep so the gecko can burrow.", source: "african-fat-tail-tank-setup-guide" },
        ...
        { label: "Three hides", value: "A warm hide, a cool hide and a humid hide are what let a gecko choose its temperature and humidity while staying concealed, which is behavioral choice rather than a checklist item.", source: "african-fat-tail-enrichment-guide" },
        { label: "Feeding schedule and portion", value: "Hatchlings eat daily. Adults run from 3 times a week to a condition-based schedule where a gecko with a visibly fat tail eats only every 5 days. Roughly 2 appropriately sized bugs per inch of the gecko's body length, or simply as much as it eats in about 15 minutes.", source: "african-fat-tail-feeding-guide" },
        ...
        { label: "Handling, week one", value: "Two weeks after it comes home, and not before it is eating regularly.", source: "african-fat-tail-handling-guide" },
        { label: "Tail drop", value: "Yes, if it is grabbed roughly or badly frightened, which is why the tail is never a handhold.", source: "african-fat-tail-handling-guide" },
        { label: "The two to watch", value: "Retained shed on the toes and tail tip, the single most common fat-tail-specific problem. Metabolic bone disease, from calcium or vitamin D3 deficiency, often alongside missing UVB.", source: "african-fat-tail-health-issues-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "UVB", value: "Not strictly required, since a complete diet powder already supplies vitamin D3, but low-level UVB is still worth adding: a 24-inch T5 HO around 5.0, for a UVI of 1.0 to 2.0.", source: "crested-gecko-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        { label: "Day one", value: "A new gecko is quarantined away from any reptile you already keep, on paper towel, with its own tools and a fecal exam inside that window.", source: "reptile-quarantine-guide" },
        { label: "Enclosure", value: "18x18x24 inches is the minimum for a single adult, with 24x24x24 inches as the ideal. Vertical space matters more than floor space.", source: "gargoyle-gecko-tank-setup-guide" },
        ...
        { label: "Temperature, and the ceiling", value: "A gradient: a cool end around 70 to 75°F and a basking spot around 82 to 85°F, with ambient temperature sitting at or below about 82°F. Air above 86°F is dangerous, which is a lower limit than almost any other lizard in the hobby.", source: "gargoyle-gecko-tank-setup-guide" },
        { label: "Heat source", value: "A low-wattage bulb or ceramic heat emitter on a thermostat, over one side of a screen top so the basking branches reach range.", source: "gargoyle-gecko-tank-setup-guide" },
        { label: "Humidity", value: "Target 50 to 70%. Mist heavily in the evening, and let it dry back down toward 50% before misting again.", source: "gargoyle-gecko-tank-setup-guide" },
        { label: "Substrate", value: "Coconut fiber works well for humidity retention, and paper towel is a solid budget option, especially for hatchlings or a sick gecko.", source: "gargoyle-gecko-tank-setup-guide" },
        ...
        { label: "Clutter", value: "Branches, vines, and cork bark genuinely help prevent floppy tail syndrome by giving your gecko somewhere other than bare glass to rest.", source: "gargoyle-gecko-tank-setup-guide" },
        { label: "Staple diet and schedule", value: "A commercial powdered crested gecko diet, mixed with water to a ketchup-like consistency, roughly 2 to 3 parts water to 1 part powder. Hatchlings and juveniles get fresh commercial gecko diet daily, adults every 2 to 3 days.", source: "gargoyle-gecko-feeding-guide" },
        { label: "Insects and supplements", value: "1 to 2 times a week for juveniles, once a week for adults. Unlike crested geckos, live insects here are a required supplement rather than optional enrichment. Gut-load insects 24 to 48 hours before feeding and dust with a calcium supplement without D3 for most feedings, with a D3-inclusive product periodically.", source: "gargoyle-gecko-feeding-guide" },
        ...
        { label: "Tail drop", value: "Never grab or hold the tail. Unlike crested geckos, gargoyle geckos do regrow their tail.", source: "gargoyle-gecko-handling-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      intro: "The numbers a new owner needs in the first week, each taken from the article that explains it.",
      rows: [
        { label: "Enclosure size", value: "Smaller species do fine in 12x12x18 inches, with 18x18x18 better. The satanic leaf-tailed gecko, the smallest commonly kept species, does well in an 18x18x24 inch enclosure as an adult.", source: "leaf-tailed-gecko-tank-setup-guide" },
        { label: "Temperature", value: "Ambient around 68 to 75F, with a night drop to around 64 to 68F. A basking heat source is generally not needed and can be actively dangerous for this species, the opposite setup priority from most reptiles.", source: "leaf-tailed-gecko-tank-setup-guide" },
        ...
        { label: "The drying cycle", value: "Uroplatus need high humidity and drying periods between mistings, and hand spraying several times a day is hard to sustain reliably. A misting system is one of the few pieces of equipment that genuinely changes outcomes for this genus.", source: "leaf-tailed-gecko-enrichment-guide" },
        { label: "Lighting", value: "Low-output UVB, in the 2.0 to 5.0 range, is increasingly recommended for long-term health, though not definitively required. Run a standard 12-hour photoperiod on a timer.", source: "leaf-tailed-gecko-tank-setup-guide" },
        ...
        { label: "Cover, and the test for it", value: "Vertical cork slabs, branches of varied diameter, and dense live planting arranged in layers and not a single plane. The test: can you always find the gecko instantly? If so, the layout is too sparse.", source: "leaf-tailed-gecko-enrichment-guide" },
        { label: "Feeding", value: "Juveniles eat daily and adults every other day, and the portion is as much as the gecko will take in one night.", source: "leaf-tailed-gecko-tank-setup-guide" },
        { label: "Supplements", value: "Dust every feeder lightly with a single all-in-one calcium-plus-vitamin powder.", source: "leaf-tailed-gecko-tank-setup-guide" },
        { label: "Leave them alone", value: "Low traffic, low disturbance and minimal handling do more for this animal than anything you can add to the enclosure.", source: "leaf-tailed-gecko-enrichment-guide" },
        ...
        { label: "Tail drop", value: "The satanic leaf-tailed gecko does not regenerate its tail at all, while several other species regrow theirs imperfectly.", source: "leaf-tailed-gecko-handling-guide" },
        { label: "Adult size", value: "2.5 to 12 inches (6 to 30 cm) depending on species." },
        { label: "Budget, the gecko, and lifespan", value: "$250 to $800 or more. Price tracks species and locality rather than color morphs, which this genus does not have in the way a crested or leopard gecko does. 5 to 15 years in captivity, though wild-caught animals consistently live shorter lives than captive-bred ones.", source: "leaf-tailed-gecko-cost-guide" },
        { label: "Budget, the setup and the month", value: "Roughly $300 to $600, covering a tall vertical bioactive terrarium, a misting system, low-output UVB and fixture, live plants and moisture-retentive substrate, a digital hygrometer and thermometer, and a magnetic feeding ledge. Roughly $20 to $40 a month.", source: "leaf-tailed-gecko-cost-guide" },
        ...
        { label: "Hygiene", value: "Never clean the enclosure, water dish or any equipment in a kitchen sink or a bathtub people also use.", source: "reptile-salmonella-hygiene-guide" },
        { label: "Power outage", value: "A healthy adult in most commonly kept species tolerates a few hours to one cool night without real harm.", source: "reptile-emergency-plan-guide" },
      ],
    },
    emergencyCard: {
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        { label: "Day one", value: "A new gecko is quarantined away from any reptile you already keep, on paper towel, with its own tools and a fecal exam inside that window.", source: "reptile-quarantine-guide" },
        { label: "Buy more than one", value: "Mourning geckos are parthenogenetic. There are no males, reproduction happens without them, and they live in colonies.", source: "mourning-gecko-enrichment-guide" },
        { label: "Enclosure", value: "A 12x18x18 inch, tall, front-opening enclosure works for a pair or small group of up to about three to five. Height matters more than floor space for this arboreal species.", source: "mourning-gecko-tank-setup-guide" },
        { label: "Escape-proofing", value: "Seal every gap you can find with aquarium-safe putty or a similar barrier before adding any geckos to a new enclosure.", source: "mourning-gecko-tank-setup-guide" },
        { label: "Temperature", value: "A daytime ambient temperature of 70 to 80°F with a warm basking spot up to 85°F, dropping to 65 to 72°F at night. At normal room temperature, most homes need no dedicated heat source at all.", source: "mourning-gecko-tank-setup-guide" },
        { label: "Humidity and substrate", value: "Between 60 and 80%, with brief peaks up to 90% via daily mistings. Coconut coir, or a coir and sphagnum moss blend, which supports a bioactive-style setup nicely.", source: "mourning-gecko-tank-setup-guide" },
        ...
        { label: "Staple food and schedule", value: "A powdered, commercially formulated crested gecko diet mixed with water to a smoothie-like paste, roughly 2 to 3 parts water to 1 part powder. Fresh powdered diet every 48 hours, and dusted insects once or twice a week.", source: "mourning-gecko-feeding-guide" },
        ...
        { label: "Calcium", value: "Gut-load insects before offering, then dust with calcium at most feedings, rotating in a multivitamin for roughly one weekly insect feeding instead. Leave a separate open dish of calcium powder in the enclosure alongside that.", source: "mourning-gecko-feeding-guide" },
        { label: "Why calcium never lets up", value: "Mature females lay a clutch of two eggs roughly every 4 to 6 weeks, with or without a male present.", source: "mourning-gecko-health-issues-guide" },
        { label: "Feed in more than one place", value: "Shallow dishes at several heights, so feeding is distributed instead of a scrum at one point.", source: "mourning-gecko-enrichment-guide" },
        { label: "Don't handle", value: "Adults measure just 3.5 to 4 inches total and hatchlings are under an inch. A small drop, the kind that wouldn't concern you with almost any other pet, can genuinely be fatal at this scale.", source: "mourning-gecko-handling-guide" },
        { label: "Shedding", value: "What matters is what is left behind: a band around a toe or the tail tip needs humidity raised and a moist hide offered.", source: "reptile-shedding-complete-guide" },
        { label: "Hygiene", value: "Wash hands with soap right after any contact, keep the gecko out of the kitchen, and never clean the enclosure in a kitchen sink or a bathtub people use.", source: "reptile-salmonella-hygiene-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      intro: "The numbers a new owner needs in the first week, each taken from the article that explains it.",
      rows: [
        { label: "Legal check", value: "Legal with no permit in 49 of 52 jurisdictions.", source: "tokay-gecko-legal-guide" },
        { label: "Enclosure", value: "18 inches long by 18 inches wide by 36 inches tall as a minimum, larger is better. This is an arboreal species, so vertical space genuinely matters more than floor space.", source: "tokay-gecko-tank-setup-guide" },
        ...
        { label: "Humidity", value: "60 to 80% is the target range, considerably more humid than what suits a desert species. Daily or twice-daily misting, moisture-retentive substrate, sphagnum moss, and leaf litter.", source: "tokay-gecko-tank-setup-guide" },
        ...
        { label: "Lighting", value: "As a nocturnal species, tokays can technically survive without UVB if their diet supplies enough vitamin D3, but low-level UVB, a 5% or forest-strength T5 bulb, offers real benefit. Keep nights genuinely dark.", source: "tokay-gecko-tank-setup-guide" },
        ...
        { label: "Diet", value: "Insectivores. Gut-loaded crickets, dubia roaches, and similar feeder insects, with nothing offered wider than the gecko's own head. Juveniles eat daily and full-grown adults every other day.", source: "tokay-gecko-tank-setup-guide" },
        ...
        { label: "Handling, and if it bites", value: "A tokay that barks, gapes, or bites at the hand gets no sessions at all: this is a hands-off terrarium subject, and the occasional tokay that tames down is the exception. Do not pull. Tugging makes the animal tighten its grip.", source: "tokay-gecko-handling-guide" },
        { label: "The tail, and never two males", value: "Tokays can detach the tail when restrained, and the regrown tail takes about 30 days and never looks like the original. Housing two males together is a first-timer mistake: they fight, often with serious or fatal results.", source: "tokay-gecko-handling-guide" },
        { label: "Quarantine", value: "3 to 6 months for a new reptile, and the longer window is the safer one for a wild-caught animal.", source: "tokay-gecko-health-issues-guide" },
        ...
        { label: "Hygiene", value: "Wash hands with soap and running water immediately after any contact with the gecko, its enclosure, or anything that has touched either.", source: "reptile-salmonella-hygiene-guide" },
