  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "What to feed", value: "Crickets, dubia and discoid roaches, mealworms and superworms with their beetles, earthworms, hornworms, silkworms and isopods all work, and variety across the week matters more than any single feeder. Dust with a calcium powder at nearly every feeding, and add a reptile multivitamin to the rotation.", source: "fire-skink-tank-setup-guide" },
        { label: "Where the food goes", value: "Release the insects into the leaf litter rather than dropping them in a dish, so finding them is the activity. Nothing has been published on this species itself; the nearest evidence is a study on another skink, where live feeders cut the time spent hiding.", source: "fire-skink-tank-setup-guide" },
        ...
        { label: "Why you never see it", value: "The highest-value item and the one people skimp on because it makes the enclosure harder to inspect. Fire skinks are semi-fossorial forest floor animals that spend most of their time under things. A deep bed of coconut fiber substrate holds a tunnel shape when slightly damp and lets a skink genuinely disappear instead of scratching at a floor. Hiding and having nothing to do can look identical from outside the glass.", source: "fire-skink-enrichment-guide" },
        ...
        { label: "Quarantine", value: "A new snake or lizard can look completely healthy while it is still shedding mites or a fatal virus. Quarantine periods of 3 to 6 months for new reptiles are recommended.", source: "reptile-quarantine-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding", value: "Offer no more than five to seven insects at a feeding, none larger than the space between the chameleon's eyes. Overfeeding is its own risk here, since gout in this species traces back to too much protein as readily as to too little water.", source: "jacksons-chameleon-tank-setup-guide" },
        { label: "What to feed", value: "Live insects, varied: crickets, roaches, silkworms, superworms, mealworms, grasshoppers and wax worms, along with pesticide-free snails, slugs, caterpillars and flies.", source: "jacksons-chameleon-tank-setup-guide" },
        { label: "Gut-loading", value: "Gut-load the insects before they go in. What the cricket ate is what the chameleon gets.", source: "jacksons-chameleon-tank-setup-guide" },
        { label: "Supplements, lightly", value: "Supplement lightly, on a weekly rhythm: calcium dusted onto an adult's non-breeding diet once weekly, and a general vitamin and mineral supplement that may go on once weekly too. This is a species where more is a real risk: avoid products high in vitamin D, which can reach toxicity, and go carefully with synthetic vitamin A, which this species is especially sensitive to and which drives the edema and gout it is prone to.", source: "jacksons-chameleon-tank-setup-guide" },
        ...
        { label: "Legal, before you buy", value: "Hawaii and the District of Columbia bar private ownership. New Jersey requires a possession permit, and Minnesota and Maine attach conditions. The other 47 jurisdictions place no restriction on it. Hawaii is also the place in the United States where you are most likely to see one, because the islands have carried established feral populations for decades.", source: "jacksons-chameleon-legal-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Lifespan", value: "15 to 20 years is the number most commonly cited for this species. Truly high-quality care can push a uromastyx's lifespan past 25 years, with some individuals reportedly reaching as old as 60.", source: "uromastyx-cost-guide" },
        ...
        { label: "Feeding schedule", value: "Babies and juveniles get fresh vegetables and greens daily, as much as they'll clean up in one sitting. Adults: anywhere from 2 to 4 times a week up to 5 to 7 days a week. Lean toward the less-frequent end, since overfeeding is described as a real and common mistake in this species rather than a theoretical risk, especially if your Uromastyx is holding weight easily.", source: "uromastyx-feeding-guide" },
        ...
        { label: "Seeds, limited", value: "Seeds and legumes, soaked or sprouted lentils, white millet, small amounts of sesame, go in anywhere from no more than once a week, to avoid obesity, to small amounts several times weekly. Treat seeds as limited, not a daily component either way.", source: "uromastyx-feeding-guide" },
        { label: "Insects", value: "Some traditional care sheets allow small amounts of mealworms occasionally, but wild-diet studies put insects at only about 1 to 6% of stomach contents, likely eaten by accident, so treat insects as optional at best, not a required part of the diet.", source: "uromastyx-feeding-guide" },
