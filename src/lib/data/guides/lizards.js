  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Housed alone", value: "Don't house multiple anoles together, they don't coexist peacefully. Two males is the version that fails fastest: the dewlap is a territorial signaling structure and males use it constantly, so two in one enclosure means an argument that never resolves, and the loser stops feeding.", source: "green-anole-tank-setup-guide" },
        { label: "Why they can't share", value: "In a group, an anole that cannot get out of another anole's sight has no way to end an encounter, and continuous low-level display is how subordinate anoles get run down.", source: "green-anole-enrichment-guide" },
        ...
        { label: "Feeding", value: "Two to three food items per feeding. A hatchling or young anole gets that once a day, an adult every other day. Crickets, dubia and discoid nymphs, red runner and red head roaches, flightless fruit flies, black soldier fly larvae and the occasional mealworm all work.", source: "green-anole-tank-setup-guide" },
        { label: "Prey size", value: "No wider than the space between the anole's eyes. This is a small lizard with a small mouth, and an oversized insect is a real choking and stress risk rather than a theoretical one.", source: "green-anole-tank-setup-guide" },
        ...
        { label: "Lifespan", value: "Casually kept green anoles are often reported living just 3 to 4 years, while appropriate care takes one to 10 years and possibly longer. The gap between those two numbers is almost entirely a setup problem, not a species limitation.", source: "green-anole-cost-guide" },
    ...
    emergencyCard: {
      ...
      callNow: [
        ...
        "Retained shed around the toes or tail, where it can constrict circulation",
