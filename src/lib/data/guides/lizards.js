export const lizardGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding schedule", value: "Daily and unlimited up to about 6 months, then every other day, what it finishes in 5 to 10 minutes. Small frequent meals over large occasional ones.", source: "ackie-monitor-feeding-guide" },
        ...
        { label: "Budget", value: "$150 to $450 for the monitor, red ackies at the top. Setup $800 to $1,500 or more, then $40 to $80 a month, most of it feeders and the high-wattage bulbs.", source: "ackie-monitor-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Enclosure", value: "8 by 4 by 4 feet minimum for an adult male, and many keepers go to 10 by 5 by 5 or a room. A hatchling starts around 40 gallons and outgrows it inside a year. The ready-made 8-foot PVC unit is 8x2x2, so adult housing is a DIY build.", source: "argentine-tegu-tank-setup-guide" },
        ...
        { label: "Supplements", value: "Calcium without D3 on every meal, a multivitamin once a week, at every age.", source: "argentine-tegu-tank-setup-guide" },
        { label: "Never from your hand", value: "A hungry tegu does not distinguish a finger from food. A bowl, tongs, a puzzle feeder, or a separate feeding container, which also teaches it that the enclosure is not where food appears.", source: "argentine-tegu-tank-setup-guide" },
        { label: "Handling, the honest version", value: "The dog-like temperament is earned through regular supervised handling and free-roam time. Approach from the side, never from above, and never disturb one in its hide.", source: "argentine-tegu-handling-guide" },
        ...
        { label: "Brumation", value: "Roughly 2 to 4 months of slowing, eating less, and burrowing from mid-September, even indoors. Not required, harmless to skip, and handling is closed for that season.", source: "argentine-tegu-handling-guide" },
        { label: "Adult size", value: "3 to 5 feet (90 to 150 cm)." },
        { label: "Budget", value: "$200 to $500 for a black and white, blue, or Chacoan tegu, $700 to $1,200 for rare morphs. Setup often exceeds $1,000 to $3,000, then $40 to $100 a month.", source: "argentine-tegu-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Enclosure", value: "4x2x2 feet minimum for either type, front-opening PVC over glass since it holds humidity, which matters more for an Indonesian.", source: "blue-tongue-skink-tank-setup-guide" },
        ...
        { label: "Settling in", value: "A captive-bred skink settles in about 2 weeks; a wild-caught Indonesian can take up to 2 months, hiding and refusing food meanwhile.", source: "blue-tongue-skink-feeding-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "The thermostat", value: "The $130 unit priced in the cost guide is an on/off model, and its maker says not to run a basking bulb on one. A bulb wants a dimming thermostat, which costs more.", source: "fire-skink-cost-guide" },
        ...
        { label: "Budget", value: "$25 to $40 for a wild-caught skink, more for captive-bred, which tames better. Setup roughly $660 to $720 with the on/off thermostat, then $40 to $65 a month.", source: "fire-skink-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Live prey to chase", value: "Released into the planting rather than a dish. The chase is the part a bowl removes.", source: "green-anole-enrichment-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Temperature", value: "Basking 100 to 120°F from a cluster of roughly six halogens over a sturdy perch, cool end around 80°F, nights not below the low 70s.", source: "green-iguana-tank-setup-guide" },
        ...
        { label: "Diet", value: "Strictly plant-based: no insects, dog or cat food, or eggs, ever. Animal protein, chronic dehydration, and over-supplemented vitamin D are the husbandry failures behind kidney disease.", source: "green-iguana-health-issues-guide" },
        ...
        { label: "Budget", value: "Farm-raised babies run $20 to $100, morphs $300 to $1,000 or more. The first-year kit is about $985 to $1,100, and the adult enclosure is a second purchase a year or two later. Ongoing $60 to $150 a month.", source: "green-iguana-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Temperature, the defining difference", value: "Basking around 85°F, but ambient air at 68 to 75°F and a real night drop to 50 to 65°F. No night heat; it works against this montane species, and most captive ones are kept too warm.", source: "jacksons-chameleon-tank-setup-guide" },
        { label: "Humidity", value: "30 to 50% by day, 75 to 100% overnight, from morning and evening misting and a cool-mist humidifier on a humidistat for the night spike. Distilled water in the equipment, and never a fogger while the heat lamp is on.", source: "jacksons-chameleon-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Company", value: "Hatchlings reared alone for two months grew up duller and worse at finding food. Adults are still never housed together.", source: "veiled-chameleon-enrichment-guide" },
        { label: "Budget", value: "$20 to $100 for a captive-bred juvenile and roughly $400 to $800 for the setup. Egg-binding runs $200 to $400 medically and $800 to $1,500 or more in surgery.", source: "veiled-chameleon-cost-guide" },
