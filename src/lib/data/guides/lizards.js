  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$25 to $40 for a wild-caught skink, more for captive-bred, which tames better. Setup roughly $660 to $720 with the on/off thermostat, then $40 to $65 a month. An annual exotic checkup, with parasite screening for a wild-caught animal.", source: "fire-skink-cost-guide" },
