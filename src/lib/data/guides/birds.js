  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$20 to $80 for the bird, $165 to $465 for a complete starter setup, and a bare-minimum first year, bird included, around $325. Food runs $5 to $30 a month, toys and perches $10 to $20.", source: "budgie-cost-guide" },
    ...
    routes: [
      { slug: "budgie-cost-guide", line: "$20 to $80 for the bird, $165 to $465 for a starter setup, and the avian vet costs most owners underestimate." },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Adult size", value: "3.9 to 4.3 inches (10 to 11 cm), 0.35 to 0.56 oz (10 to 16 g)." },
