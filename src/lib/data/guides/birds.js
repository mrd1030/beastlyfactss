  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Feeding style", value: "Wild parrots spend up to six hours a day working for food; a full bowl is done in minutes, and most behavior problems grow in that empty stretch. Loud, disproportionately, and no enrichment fixes that. Alone works only with a very involved owner.", source: "conure-enrichment-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Foraging", value: "Wild parrots work up to six hours a day for food. Hanging forage toys for a small beak, food wrapped in paper, tucked in cardboard, split across several sites, and a bath, which they take readily.", source: "parrotlet-enrichment-guide" },
