  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Diet split", value: "Pellets roughly 70% of the diet, fresh fruit and vegetables another 20%, and seed limited to about one level teaspoon per bird per day.", source: "zebra-finch-feeding-guide" },
