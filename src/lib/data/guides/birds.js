export const birdGuides = [
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Bar spacing", value: "3/4 inch to 1 inch, and no wider than 1 inch.", source: "african-grey-parrot-tank-setup-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$20 to $80 for the bird, $175 to $475 for a complete starter setup, and a bare-minimum first year, bird included, around $325. Food runs $5 to $15 a month, toys and perches $10 to $30.", source: "budgie-cost-guide" },
  ...
  },
  {
    ...
    firstWeek: {
      ...
      rows: [
        ...
        { label: "Budget", value: "$75 to $250 for the bird, $320 to $860 for a complete starter setup, and $200 to $350 a year after that. Avian exams come on top, at least yearly; reproductive emergencies like egg binding can run $300 to $800 or more.", source: "cockatiel-cost-guide" },
