export const invertebrateEncyclopedia = [
  ...
  },
  {
    ...
    bio: {
      overview: "The cherry shrimp is one of the most popular freshwater aquarium shrimp species in the hobby, prized for breeding readily in plain freshwater and for the huge range of selectively bred colors developed from a single dull, translucent wild form. Native to streams and rivers in Taiwan, eastern China, the Korean peninsula, and Vietnam, wild cherry shrimp are a camouflaged greenish-brown, nothing like the vivid reds, blues, and yellows sold in stores today. They spend their days grazing biofilm and algae off any surface they can reach, doing genuine cleanup work in a planted tank while asking for almost nothing in return.",
      origin: "Taiwan, eastern China, the Korean peninsula, and Vietnam",
  ...
  },
  {
    ...
    bio: {
      ...
      wildLifespan: "Not well documented in the wild; typically 5-7 years in captivity, and some individuals pass 10",
      conservation: "Least Concern (IUCN)",
  ...
  },
  {
    ...
    bio: {
      ...
      wildLifespan: "Shorter in the wild, where predation, food gaps and weather take their toll; 1-2 years in captivity, and a well-kept female can go longer",
