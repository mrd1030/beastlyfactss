export const snakeEncyclopedia = [
  ...
  },
  {
    ...
    bio: {
      overview: "The rosy boa is a small, desert-dwelling boa native to the arid Southwestern United States and Baja California, Mexico - a striking contrast to the Boa constrictor, which can grow six to ten times longer. Typically 2 to 3 feet as adults and rarely over 4, rosy boas are famously docile and slow-moving even by boa standards, rarely bite, and are frequently recommended as one of the calmest snakes in the entire hobby. Their desert origin means lower humidity and simpler climate needs than the tropical boas and pythons it shares a shelf with. With proper care they're also remarkably long-lived, averaging 18 to 22 years in captivity with documented individuals past 30.",
      ...
      wildLifespan: "18-22 years average in captivity, past 30 documented (wild lifespan undocumented)",
      conservation: "Least Concern (IUCN)",
