export const birdEncyclopedia = [
  ...
  },
  {
    ...
    bio: {
      ...
      wildLifespan: "A domesticated bird, so there is no wild figure; typically 6 to 12 years in captivity, up to 15, and 24 years is the longevity record",
  ...
  },
  {
    ...
    bio: {
      overview: "Green cheek conures are small parrots native to the forests of Bolivia, Brazil, Argentina, and Paraguay, where they live in noisy flocks in the forest canopy. They are among the quietest of the conure species - making them more apartment-friendly than larger parrots - and have a reputation for playfulness and deep affection. They bond closely with their keepers, and that bond is built on time: a conure needs three to four hours of supervised time out of the cage every day.",
  ...
  },
  {
    ...
    bio: {
      ...
      adultSize: "3.9-4.3 inches (10-11 cm); 0.35-0.56 oz (10-16 g)",
