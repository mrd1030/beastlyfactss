...
export const RELATED_ARTICLES = {
  'betta-fish': ['betta-fish-water-parameters-guide', 'betta-fish-cost-guide', 'betta-fish-handling-guide', 'betta-fish-health-issues-guide', 'betta-fish-tank-setup-guide', 'betta-fish-feeding-guide', 'betta-fish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'cherry-shrimp': ['aquarium-filtration-guide'],
  'amano-shrimp': ['aquarium-filtration-guide'],
  'ghost-shrimp': ['aquarium-filtration-guide'],
  'goldfish': ['goldfish-tank-size-bowl-myth', 'goldfish-cost-guide', 'goldfish-handling-guide', 'goldfish-health-issues-guide', 'goldfish-tank-setup-guide', 'goldfish-feeding-guide', 'goldfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'axolotl': ['axolotl-legal-guide', 'axolotl-cost-guide', 'axolotl-handling-guide', 'axolotl-health-issues-guide', 'axolotl-tank-setup-guide', 'axolotl-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'reptile-salmonella-hygiene-guide', 'aquarium-filtration-guide'],
  ...
  'koi': ['koi-cost-guide', 'koi-handling-guide', 'koi-health-issues-guide', 'koi-tank-setup-guide', 'koi-feeding-guide', 'koi-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'guppy': ['guppy-cost-guide', 'guppy-handling-guide', 'guppy-health-issues-guide', 'guppy-tank-setup-guide', 'guppy-feeding-guide', 'guppy-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'neon-tetra': ['neon-tetra-cost-guide', 'neon-tetra-handling-guide', 'neon-tetra-health-issues-guide', 'neon-tetra-tank-setup-guide', 'neon-tetra-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'angelfish': ['angelfish-cost-guide', 'angelfish-handling-guide', 'angelfish-health-issues-guide', 'angelfish-tank-setup-guide', 'angelfish-feeding-guide', 'angelfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'oscar': ['oscar-fish-cost-guide', 'oscar-fish-handling-guide', 'oscar-fish-health-issues-guide', 'oscar-fish-tank-setup-guide', 'oscar-fish-feeding-guide', 'oscar-fish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'corydoras-catfish': ['corydoras-catfish-cost-guide', 'corydoras-catfish-handling-guide', 'corydoras-catfish-health-issues-guide', 'corydoras-catfish-tank-setup-guide', 'corydoras-catfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  ...
  'bristlenose-pleco': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'cardinal-tetra': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'discus': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'molly': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'platy': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'swordtail': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
  'zebra-danio': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'aquarium-filtration-guide'],
};
