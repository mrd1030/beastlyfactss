...
export const RELATED_ARTICLES = {
  ...
  'axolotl': ['axolotl-legal-guide', 'axolotl-cost-guide', 'axolotl-handling-guide', 'axolotl-health-issues-guide', 'axolotl-tank-setup-guide', 'axolotl-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'ball-python': ['snake-brumation-guide', 'ball-python-legal-guide', 'ball-python-cost-guide', 'ball-python-handling-guide', 'ball-python-health-issues-guide', 'ball-python-tank-setup-guide', 'ball-python-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'corn-snake': ['snake-brumation-guide', 'corn-snake-cost-guide', 'corn-snake-handling-guide', 'corn-snake-health-issues-guide', 'corn-snake-tank-setup-guide', 'corn-snake-feeding-guide', 'corn-snake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'garter-snake': ['garter-snake-legal-guide', 'garter-snake-cost-guide', 'garter-snake-handling-guide', 'garter-snake-health-issues-guide', 'garter-snake-tank-setup-guide', 'garter-snake-feeding-guide', 'garter-snake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'crested-gecko': ['crested-gecko-cost-guide', 'crested-gecko-handling-guide', 'crested-gecko-health-issues-guide', 'crested-gecko-tank-setup-guide', 'crested-gecko-enrichment-guide', 't5-vs-compact-uvb-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'gargoyle-gecko': ['gargoyle-gecko-cost-guide', 'gargoyle-gecko-handling-guide', 'gargoyle-gecko-health-issues-guide', 'gargoyle-gecko-tank-setup-guide', 'gargoyle-gecko-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'mourning-gecko': ['mourning-gecko-cost-guide', 'mourning-gecko-handling-guide', 'mourning-gecko-health-issues-guide', 'mourning-gecko-tank-setup-guide', 'mourning-gecko-feeding-guide', 'mourning-gecko-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'african-fat-tail': ['african-fat-tail-cost-guide', 'african-fat-tail-handling-guide', 'african-fat-tail-health-issues-guide', 'african-fat-tail-tank-setup-guide', 'african-fat-tail-feeding-guide', 'african-fat-tail-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'red-eared-slider': ['red-eared-slider-legal-guide', 'red-eared-slider-cost-guide', 'red-eared-slider-handling-guide', 'red-eared-slider-health-issues-guide', 'red-eared-slider-tank-setup-guide', 'red-eared-slider-feeding-guide', 'red-eared-slider-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'hognose-snake': ['hognose-snake-legal-guide', 'hognose-snake-cost-guide', 'hognose-snake-handling-guide', 'hognose-snake-health-issues-guide', 'hognose-snake-tank-setup-guide', 'hognose-snake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'blue-tongue-skink': ['blue-tongue-skink-cost-guide', 'blue-tongue-skink-handling-guide', 'blue-tongue-skink-health-issues-guide', 'blue-tongue-skink-tank-setup-guide', 'blue-tongue-skink-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'whites-tree-frog': ['whites-tree-frog-cost-guide', 'whites-tree-frog-handling-guide', 'whites-tree-frog-health-issues-guide', 'whites-tree-frog-tank-setup-guide', 'whites-tree-frog-enrichment-guide', 'reptile-salmonella-hygiene-guide'],
  'pacman-frog': ['pacman-frog-cost-guide', 'pacman-frog-handling-guide', 'pacman-frog-health-issues-guide', 'pacman-frog-tank-setup-guide', 'pacman-frog-enrichment-guide', 'reptile-salmonella-hygiene-guide'],
  'sulcata-tortoise': ['sulcata-tortoise-legal-guide', 'sulcata-tortoise-cost-guide', 'sulcata-tortoise-handling-guide', 'sulcata-tortoise-health-issues-guide', 'sulcata-tortoise-tank-setup-guide', 'sulcata-tortoise-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'boa-constrictor': ['boa-constrictor-legal-guide', 'boa-constrictor-cost-guide', 'boa-constrictor-handling-guide', 'boa-constrictor-health-issues-guide', 'boa-constrictor-tank-setup-guide', 'boa-constrictor-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'ackie-monitor': ['ackie-monitor-cost-guide', 'ackie-monitor-handling-guide', 'ackie-monitor-health-issues-guide', 'ackie-monitor-tank-setup-guide', 'ackie-monitor-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'milk-snake': ['milk-snake-cost-guide', 'milk-snake-handling-guide', 'milk-snake-health-issues-guide', 'milk-snake-tank-setup-guide', 'milk-snake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'uromastyx': ['uromastyx-cost-guide', 'uromastyx-handling-guide', 'uromastyx-health-issues-guide', 'uromastyx-tank-setup-guide', 'uromastyx-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'tokay-gecko': ['tokay-gecko-cost-guide', 'tokay-gecko-handling-guide', 'tokay-gecko-health-issues-guide', 'tokay-gecko-tank-setup-guide', 'tokay-gecko-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'savannah-monitor': ['savannah-monitor-cost-guide', 'savannah-monitor-handling-guide', 'savannah-monitor-health-issues-guide', 'savannah-monitor-tank-setup-guide', 'savannah-monitor-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'leaf-tailed-gecko': ['leaf-tailed-gecko-cost-guide', 'leaf-tailed-gecko-handling-guide', 'leaf-tailed-gecko-health-issues-guide', 'leaf-tailed-gecko-tank-setup-guide', 'leaf-tailed-gecko-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'california-kingsnake': ['california-kingsnake-cost-guide', 'california-kingsnake-handling-guide', 'california-kingsnake-health-issues-guide', 'california-kingsnake-tank-setup-guide', 'california-kingsnake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'rosy-boa': ['rosy-boa-legal-guide', 'rosy-boa-cost-guide', 'rosy-boa-handling-guide', 'rosy-boa-health-issues-guide', 'rosy-boa-tank-setup-guide', 'rosy-boa-feeding-guide', 'rosy-boa-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'box-turtle': ['box-turtle-legal-guide', 'box-turtle-cost-guide', 'box-turtle-handling-guide', 'box-turtle-health-issues-guide', 'box-turtle-tank-setup-guide', 'box-turtle-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  ...
  'green-anole': ['green-anole-cost-guide', 'green-anole-handling-guide', 'green-anole-health-issues-guide', 'green-anole-tank-setup-guide', 'green-anole-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'tegu': ['argentine-tegu-legal-guide', 'argentine-tegu-cost-guide', 'argentine-tegu-handling-guide', 'argentine-tegu-health-issues-guide', 'argentine-tegu-tank-setup-guide', 'argentine-tegu-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'fire-bellied-toad': ['fire-bellied-toad-cost-guide', 'fire-bellied-toad-handling-guide', 'fire-bellied-toad-health-issues-guide', 'fire-bellied-toad-tank-setup-guide', 'fire-bellied-toad-enrichment-guide', 'reptile-salmonella-hygiene-guide'],
  'tiger-salamander': ['tiger-salamander-legal-guide', 'tiger-salamander-cost-guide', 'tiger-salamander-handling-guide', 'tiger-salamander-health-issues-guide', 'tiger-salamander-tank-setup-guide', 'tiger-salamander-enrichment-guide', 'reptile-salmonella-hygiene-guide'],
  'green-iguana': ['iguana-fireskink-quaker-overview', 'green-iguana-cost-guide', 'green-iguana-handling-guide', 'green-iguana-health-issues-guide', 'green-iguana-tank-setup-guide', 'green-iguana-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
  'fire-skink': ['iguana-fireskink-quaker-overview', 'fire-skink-cost-guide', 'fire-skink-handling-guide', 'fire-skink-health-issues-guide', 'fire-skink-tank-setup-guide', 'fire-skink-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide'],
