...
export const RELATED_ARTICLES = {
  ...
  'budgie': ['budgie-cere-color-guide', 'budgie-cost-guide', 'budgie-handling-guide', 'budgie-health-issues-guide', 'budgie-tank-setup-guide', 'budgie-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  'cockatiel': ['cockatiel-cost-guide', 'cockatiel-handling-guide', 'cockatiel-health-issues-guide', 'cockatiel-tank-setup-guide', 'cockatiel-feeding-guide', 'cockatiel-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  ...
  'tarantula': ['invertebrate-molting-guide', 'tarantula-cost-guide', 'tarantula-handling-guide', 'tarantula-health-issues-guide', 'tarantula-tank-setup-guide', 'tarantula-feeding-guide', 'tarantula-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  'hermit-crab': ['invertebrate-molting-guide', 'hermit-crab-cost-guide', 'hermit-crab-handling-guide', 'hermit-crab-health-issues-guide', 'hermit-crab-tank-setup-guide', 'hermit-crab-enrichment-guide', 'invertebrate-pesticide-hazards-guide'],
  ...
  'praying-mantis': ['praying-mantis-ootheca-guide', 'praying-mantis-cost-guide', 'praying-mantis-handling-guide', 'praying-mantis-health-issues-guide', 'praying-mantis-tank-setup-guide', 'praying-mantis-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  ...
  'conure': ['conure-cost-guide', 'conure-handling-guide', 'conure-health-issues-guide', 'conure-tank-setup-guide', 'conure-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  ...
  'emperor-scorpion': ['emperor-scorpion-cost-guide', 'emperor-scorpion-handling-guide', 'emperor-scorpion-health-issues-guide', 'emperor-scorpion-tank-setup-guide', 'emperor-scorpion-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  ...
  'lovebird': ['lovebird-cost-guide', 'lovebird-handling-guide', 'lovebird-health-issues-guide', 'lovebird-tank-setup-guide', 'lovebird-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  ...
  'african-grey': ['african-grey-parrot-legal-guide', 'african-grey-parrot-cost-guide', 'african-grey-parrot-handling-guide', 'african-grey-parrot-health-issues-guide', 'african-grey-parrot-tank-setup-guide', 'african-grey-parrot-enrichment-guide', 'african-grey-parrot-feeding-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  'jumping-spider': ['invertebrate-molting-guide', 'jumping-spider-feeding-guide', 'jumping-spider-cost-guide', 'jumping-spider-handling-guide', 'jumping-spider-health-issues-guide', 'jumping-spider-tank-setup-guide', 'jumping-spider-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  ...
  'cockatoo': ['cockatoo-cost-guide', 'cockatoo-handling-guide', 'cockatoo-health-issues-guide', 'cockatoo-tank-setup-guide', 'cockatoo-screaming-feather-plucking-explained', 'cockatoo-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  'stick-insect': ['stick-insect-cost-guide', 'stick-insect-handling-guide', 'stick-insect-health-issues-guide', 'stick-insect-tank-setup-guide', 'stick-insect-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  ...
  'canary': ['canary-cost-guide', 'canary-handling-guide', 'canary-health-issues-guide', 'canary-tank-setup-guide', 'canary-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  'millipede': ['giant-millipede-cost-guide', 'giant-millipede-handling-guide', 'giant-millipede-health-issues-guide', 'giant-millipede-tank-setup-guide', 'giant-millipede-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide'],
  ...
  'quaker-parakeet': ['iguana-fireskink-quaker-overview', 'quaker-parakeet-cost-guide', 'quaker-parakeet-handling-guide', 'quaker-parakeet-health-issues-guide', 'quaker-parakeet-tank-setup-guide', 'quaker-parakeet-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  ...
  'parrotlet': ['bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
  'zebra-finch': ['bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide'],
