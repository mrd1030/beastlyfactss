...
export const RELATED_ARTICLES = {
  'betta-fish': ['betta-fish-water-parameters-guide', 'betta-fish-cost-guide', 'betta-fish-handling-guide', 'betta-fish-health-issues-guide', 'betta-fish-tank-setup-guide', 'betta-fish-feeding-guide', 'betta-fish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'budgie': ['budgie-cere-color-guide', 'budgie-cost-guide', 'budgie-handling-guide', 'budgie-health-issues-guide', 'budgie-tank-setup-guide', 'budgie-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  'cockatiel': ['cockatiel-cost-guide', 'cockatiel-handling-guide', 'cockatiel-health-issues-guide', 'cockatiel-tank-setup-guide', 'cockatiel-feeding-guide', 'cockatiel-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  'veiled-chameleon': ['chameleon-hydration-drippers-misters-fogging', 'veiled-chameleon-cost-guide', 'veiled-chameleon-handling-guide', 'veiled-chameleon-health-issues-guide', 'veiled-chameleon-tank-setup-guide', 'veiled-chameleon-enrichment-guide', 't5-vs-compact-uvb-guide', 'reptile-emergency-plan-guide'],
  'chameleon': ['chameleon-hydration-drippers-misters-fogging', 'jacksons-chameleon-cost-guide', 'jacksons-chameleon-handling-guide', 'jacksons-chameleon-health-issues-guide', 'jacksons-chameleon-tank-setup-guide', 'jacksons-chameleon-enrichment-guide', 'reptile-emergency-plan-guide'],
  ...
  'goldfish': ['goldfish-tank-size-bowl-myth', 'goldfish-cost-guide', 'goldfish-handling-guide', 'goldfish-health-issues-guide', 'goldfish-tank-setup-guide', 'goldfish-feeding-guide', 'goldfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  ...
  'axolotl': ['axolotl-legal-guide', 'axolotl-cost-guide', 'axolotl-handling-guide', 'axolotl-health-issues-guide', 'axolotl-tank-setup-guide', 'axolotl-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'chinchilla': ['chinchilla-legal-guide', 'chinchilla-cost-guide', 'chinchilla-handling-guide', 'chinchilla-health-issues-guide', 'chinchilla-tank-setup-guide', 'chinchilla-feeding-guide', 'chinchilla-enrichment-guide', 'small-mammal-enterotoxemia-guide'],
  ...
  'rabbit': ['rabbit-gi-stasis-guide', 'rabbit-cost-guide', 'rabbit-handling-guide', 'rabbit-health-issues-guide', 'rabbit-tank-setup-guide', 'rabbit-feeding-guide', 'rabbit-enrichment-guide', 'small-mammal-enterotoxemia-guide'],
  'ball-python': ['snake-brumation-guide', 'ball-python-legal-guide', 'ball-python-cost-guide', 'ball-python-handling-guide', 'ball-python-health-issues-guide', 'ball-python-tank-setup-guide', 'ball-python-enrichment-guide', 'reptile-emergency-plan-guide'],
  'corn-snake': ['snake-brumation-guide', 'corn-snake-cost-guide', 'corn-snake-handling-guide', 'corn-snake-health-issues-guide', 'corn-snake-tank-setup-guide', 'corn-snake-feeding-guide', 'corn-snake-enrichment-guide', 'reptile-emergency-plan-guide'],
  'garter-snake': ['garter-snake-legal-guide', 'garter-snake-cost-guide', 'garter-snake-handling-guide', 'garter-snake-health-issues-guide', 'garter-snake-tank-setup-guide', 'garter-snake-feeding-guide', 'garter-snake-enrichment-guide', 'reptile-emergency-plan-guide'],
  ...
  'hamster': ['hamster-cost-guide', 'hamster-handling-guide', 'hamster-health-issues-guide', 'hamster-tank-setup-guide', 'hamster-feeding-guide', 'hamster-enrichment-guide', 'small-mammal-enterotoxemia-guide'],
  ...
  'guinea-pig': ['guinea-pig-scurvy-vitamin-c-guide', 'guinea-pig-cost-guide', 'guinea-pig-handling-guide', 'guinea-pig-health-issues-guide', 'guinea-pig-tank-setup-guide', 'guinea-pig-feeding-guide', 'guinea-pig-enrichment-guide', 'small-mammal-enterotoxemia-guide'],
  'degu': ['degu-gerbil-overview', 'degu-cost-guide', 'degu-handling-guide', 'degu-health-issues-guide', 'degu-tank-setup-guide', 'degu-enrichment-guide', 'small-mammal-enterotoxemia-guide'],
  'gerbil': ['degu-gerbil-overview', 'gerbil-cost-guide', 'gerbil-handling-guide', 'gerbil-health-issues-guide', 'gerbil-tank-setup-guide', 'gerbil-enrichment-guide'],
  'bearded-dragon': ['bearded-dragon-cost-guide', 'bearded-dragon-handling-guide', 'bearded-dragon-health-issues-guide', 'bearded-dragon-tank-setup-guide', 'bearded-dragon-feeding-guide', 'bearded-dragon-enrichment-guide', 'bioactive-setups-bearded-dragons', 'bearded-dragon-shopping-list', 't5-vs-compact-uvb-guide', 'bearded-dragon-safe-foods-guide', 'reptile-emergency-plan-guide', 'bearded-dragon-brumation-guide', 'bearded-dragon-eggs-and-egg-binding-guide', 'bearded-dragon-growth-weight-checks-guide'],
  'leopard-gecko': ['leopard-gecko-cost-guide', 'leopard-gecko-handling-guide', 'leopard-gecko-health-issues-guide', 'leopard-gecko-tank-setup-guide', 'leopard-gecko-feeding-guide', 'leopard-gecko-enrichment-guide', 't5-vs-compact-uvb-guide', 'reptile-emergency-plan-guide'],
  'crested-gecko': ['crested-gecko-cost-guide', 'crested-gecko-handling-guide', 'crested-gecko-health-issues-guide', 'crested-gecko-tank-setup-guide', 'crested-gecko-enrichment-guide', 't5-vs-compact-uvb-guide', 'reptile-emergency-plan-guide'],
  'gargoyle-gecko': ['gargoyle-gecko-cost-guide', 'gargoyle-gecko-handling-guide', 'gargoyle-gecko-health-issues-guide', 'gargoyle-gecko-tank-setup-guide', 'gargoyle-gecko-enrichment-guide', 'reptile-emergency-plan-guide'],
  'mourning-gecko': ['mourning-gecko-cost-guide', 'mourning-gecko-handling-guide', 'mourning-gecko-health-issues-guide', 'mourning-gecko-tank-setup-guide', 'mourning-gecko-feeding-guide', 'mourning-gecko-enrichment-guide', 'reptile-emergency-plan-guide'],
  'african-fat-tail': ['african-fat-tail-cost-guide', 'african-fat-tail-handling-guide', 'african-fat-tail-health-issues-guide', 'african-fat-tail-tank-setup-guide', 'african-fat-tail-feeding-guide', 'african-fat-tail-enrichment-guide', 'reptile-emergency-plan-guide'],
  'koi': ['koi-cost-guide', 'koi-handling-guide', 'koi-health-issues-guide', 'koi-tank-setup-guide', 'koi-feeding-guide', 'koi-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'conure': ['conure-cost-guide', 'conure-handling-guide', 'conure-health-issues-guide', 'conure-tank-setup-guide', 'conure-enrichment-guide', 'bird-household-hazards-guide'],
  'red-eared-slider': ['red-eared-slider-legal-guide', 'red-eared-slider-cost-guide', 'red-eared-slider-handling-guide', 'red-eared-slider-health-issues-guide', 'red-eared-slider-tank-setup-guide', 'red-eared-slider-feeding-guide', 'red-eared-slider-enrichment-guide', 'reptile-emergency-plan-guide'],
  ...
  'hognose-snake': ['hognose-snake-legal-guide', 'hognose-snake-cost-guide', 'hognose-snake-handling-guide', 'hognose-snake-health-issues-guide', 'hognose-snake-tank-setup-guide', 'hognose-snake-enrichment-guide', 'reptile-emergency-plan-guide'],
  'blue-tongue-skink': ['blue-tongue-skink-cost-guide', 'blue-tongue-skink-handling-guide', 'blue-tongue-skink-health-issues-guide', 'blue-tongue-skink-tank-setup-guide', 'blue-tongue-skink-enrichment-guide', 'reptile-emergency-plan-guide'],
  'whites-tree-frog': ['whites-tree-frog-cost-guide', 'whites-tree-frog-handling-guide', 'whites-tree-frog-health-issues-guide', 'whites-tree-frog-tank-setup-guide', 'whites-tree-frog-enrichment-guide'],
  'pacman-frog': ['pacman-frog-cost-guide', 'pacman-frog-handling-guide', 'pacman-frog-health-issues-guide', 'pacman-frog-tank-setup-guide', 'pacman-frog-enrichment-guide'],
  'sulcata-tortoise': ['sulcata-tortoise-legal-guide', 'sulcata-tortoise-cost-guide', 'sulcata-tortoise-handling-guide', 'sulcata-tortoise-health-issues-guide', 'sulcata-tortoise-tank-setup-guide', 'sulcata-tortoise-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide'],
  ...
  'lovebird': ['lovebird-cost-guide', 'lovebird-handling-guide', 'lovebird-health-issues-guide', 'lovebird-tank-setup-guide', 'lovebird-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  'guppy': ['guppy-cost-guide', 'guppy-handling-guide', 'guppy-health-issues-guide', 'guppy-tank-setup-guide', 'guppy-feeding-guide', 'guppy-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'boa-constrictor': ['boa-constrictor-legal-guide', 'boa-constrictor-cost-guide', 'boa-constrictor-handling-guide', 'boa-constrictor-health-issues-guide', 'boa-constrictor-tank-setup-guide', 'boa-constrictor-enrichment-guide', 'reptile-emergency-plan-guide'],
  ...
  'neon-tetra': ['neon-tetra-cost-guide', 'neon-tetra-handling-guide', 'neon-tetra-health-issues-guide', 'neon-tetra-tank-setup-guide', 'neon-tetra-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'ackie-monitor': ['ackie-monitor-cost-guide', 'ackie-monitor-handling-guide', 'ackie-monitor-health-issues-guide', 'ackie-monitor-tank-setup-guide', 'ackie-monitor-enrichment-guide', 'reptile-emergency-plan-guide'],
  'milk-snake': ['milk-snake-cost-guide', 'milk-snake-handling-guide', 'milk-snake-health-issues-guide', 'milk-snake-tank-setup-guide', 'milk-snake-enrichment-guide', 'reptile-emergency-plan-guide'],
  ...
  'angelfish': ['angelfish-cost-guide', 'angelfish-handling-guide', 'angelfish-health-issues-guide', 'angelfish-tank-setup-guide', 'angelfish-feeding-guide', 'angelfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'uromastyx': ['uromastyx-cost-guide', 'uromastyx-handling-guide', 'uromastyx-health-issues-guide', 'uromastyx-tank-setup-guide', 'uromastyx-enrichment-guide', 'reptile-emergency-plan-guide'],
  'tokay-gecko': ['tokay-gecko-cost-guide', 'tokay-gecko-handling-guide', 'tokay-gecko-health-issues-guide', 'tokay-gecko-tank-setup-guide', 'tokay-gecko-enrichment-guide', 'reptile-emergency-plan-guide'],
  'african-grey': ['african-grey-parrot-legal-guide', 'african-grey-parrot-cost-guide', 'african-grey-parrot-handling-guide', 'african-grey-parrot-health-issues-guide', 'african-grey-parrot-tank-setup-guide', 'african-grey-parrot-enrichment-guide', 'african-grey-parrot-feeding-guide', 'bird-household-hazards-guide'],
  ...
  'savannah-monitor': ['savannah-monitor-cost-guide', 'savannah-monitor-handling-guide', 'savannah-monitor-health-issues-guide', 'savannah-monitor-tank-setup-guide', 'savannah-monitor-enrichment-guide', 'reptile-emergency-plan-guide'],
  'russian-tortoise': ['russian-tortoise-cost-guide', 'russian-tortoise-handling-guide', 'russian-tortoise-health-issues-guide', 'russian-tortoise-tank-setup-guide', 'russian-tortoise-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide'],
  'red-footed-tortoise': ['red-footed-tortoise-cost-guide', 'red-footed-tortoise-handling-guide', 'red-footed-tortoise-health-issues-guide', 'red-footed-tortoise-tank-setup-guide', 'red-footed-tortoise-feeding-guide', 'red-footed-tortoise-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide'],
  'cockatoo': ['cockatoo-cost-guide', 'cockatoo-handling-guide', 'cockatoo-health-issues-guide', 'cockatoo-tank-setup-guide', 'cockatoo-screaming-feather-plucking-explained', 'cockatoo-enrichment-guide', 'bird-household-hazards-guide'],
  ...
  'leaf-tailed-gecko': ['leaf-tailed-gecko-cost-guide', 'leaf-tailed-gecko-handling-guide', 'leaf-tailed-gecko-health-issues-guide', 'leaf-tailed-gecko-tank-setup-guide', 'leaf-tailed-gecko-enrichment-guide', 'reptile-emergency-plan-guide'],
  'california-kingsnake': ['california-kingsnake-cost-guide', 'california-kingsnake-handling-guide', 'california-kingsnake-health-issues-guide', 'california-kingsnake-tank-setup-guide', 'california-kingsnake-enrichment-guide', 'reptile-emergency-plan-guide'],
  'rosy-boa': ['rosy-boa-legal-guide', 'rosy-boa-cost-guide', 'rosy-boa-handling-guide', 'rosy-boa-health-issues-guide', 'rosy-boa-tank-setup-guide', 'rosy-boa-feeding-guide', 'rosy-boa-enrichment-guide', 'reptile-emergency-plan-guide'],
  'box-turtle': ['box-turtle-legal-guide', 'box-turtle-cost-guide', 'box-turtle-handling-guide', 'box-turtle-health-issues-guide', 'box-turtle-tank-setup-guide', 'box-turtle-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide'],
  'oscar': ['oscar-fish-cost-guide', 'oscar-fish-handling-guide', 'oscar-fish-health-issues-guide', 'oscar-fish-tank-setup-guide', 'oscar-fish-feeding-guide', 'oscar-fish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'canary': ['canary-cost-guide', 'canary-handling-guide', 'canary-health-issues-guide', 'canary-tank-setup-guide', 'canary-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  ...
  'corydoras-catfish': ['corydoras-catfish-cost-guide', 'corydoras-catfish-handling-guide', 'corydoras-catfish-health-issues-guide', 'corydoras-catfish-tank-setup-guide', 'corydoras-catfish-enrichment-guide', 'aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'green-anole': ['green-anole-cost-guide', 'green-anole-handling-guide', 'green-anole-health-issues-guide', 'green-anole-tank-setup-guide', 'green-anole-enrichment-guide', 'reptile-emergency-plan-guide'],
  'tegu': ['argentine-tegu-legal-guide', 'argentine-tegu-cost-guide', 'argentine-tegu-handling-guide', 'argentine-tegu-health-issues-guide', 'argentine-tegu-tank-setup-guide', 'argentine-tegu-enrichment-guide', 'reptile-emergency-plan-guide'],
  'fire-bellied-toad': ['fire-bellied-toad-cost-guide', 'fire-bellied-toad-handling-guide', 'fire-bellied-toad-health-issues-guide', 'fire-bellied-toad-tank-setup-guide', 'fire-bellied-toad-enrichment-guide'],
  'tiger-salamander': ['tiger-salamander-legal-guide', 'tiger-salamander-cost-guide', 'tiger-salamander-handling-guide', 'tiger-salamander-health-issues-guide', 'tiger-salamander-tank-setup-guide', 'tiger-salamander-enrichment-guide'],
  'green-iguana': ['iguana-fireskink-quaker-overview', 'green-iguana-cost-guide', 'green-iguana-handling-guide', 'green-iguana-health-issues-guide', 'green-iguana-tank-setup-guide', 'green-iguana-enrichment-guide', 'reptile-emergency-plan-guide'],
  'fire-skink': ['iguana-fireskink-quaker-overview', 'fire-skink-cost-guide', 'fire-skink-handling-guide', 'fire-skink-health-issues-guide', 'fire-skink-tank-setup-guide', 'fire-skink-enrichment-guide', 'reptile-emergency-plan-guide'],
  'quaker-parakeet': ['iguana-fireskink-quaker-overview', 'quaker-parakeet-cost-guide', 'quaker-parakeet-handling-guide', 'quaker-parakeet-health-issues-guide', 'quaker-parakeet-tank-setup-guide', 'quaker-parakeet-enrichment-guide', 'bird-household-hazards-guide'],
  ...
  'parrotlet': ['bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  'zebra-finch': ['bird-household-hazards-guide', 'avian-gastric-yeast-guide'],
  'bristlenose-pleco': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'cardinal-tetra': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'discus': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'molly': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'platy': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'swordtail': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
  'zebra-danio': ['aquarium-power-outage-and-transport-guide', 'aquarium-cycling-guide'],
};
