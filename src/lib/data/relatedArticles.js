...
export const RELATED_ARTICLES = {
  ...
  'dog-bulldog': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide'],
  'dog-dachshund': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'ivdd-and-chondrodystrophy-guide', 'periodontal-dental-disease-guide'],
  'dog-french-bulldog': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'french-bulldog-feeding-guide'],
  ...
  'cat-domestic-shorthair': ['pet-dna-test-results-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  ...
  'cat-persian': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'brachycephalic-airway-syndrome-boas-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  ...
  'cat-scottish-fold': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide'],
  ...
  'cat-sphynx': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'periodontal-dental-disease-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
