...
export const RELATED_ARTICLES = {
  ...
  'budgie': ['budgie-cere-color-guide', 'budgie-cost-guide', 'budgie-handling-guide', 'budgie-health-issues-guide', 'budgie-tank-setup-guide', 'budgie-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  'cockatiel': ['cockatiel-cost-guide', 'cockatiel-handling-guide', 'cockatiel-health-issues-guide', 'cockatiel-tank-setup-guide', 'cockatiel-feeding-guide', 'cockatiel-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'conure': ['conure-cost-guide', 'conure-handling-guide', 'conure-health-issues-guide', 'conure-tank-setup-guide', 'conure-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'lovebird': ['lovebird-cost-guide', 'lovebird-handling-guide', 'lovebird-health-issues-guide', 'lovebird-tank-setup-guide', 'lovebird-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'african-grey': ['african-grey-parrot-legal-guide', 'african-grey-parrot-cost-guide', 'african-grey-parrot-handling-guide', 'african-grey-parrot-health-issues-guide', 'african-grey-parrot-tank-setup-guide', 'african-grey-parrot-enrichment-guide', 'african-grey-parrot-feeding-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'cockatoo': ['cockatoo-cost-guide', 'cockatoo-handling-guide', 'cockatoo-health-issues-guide', 'cockatoo-tank-setup-guide', 'cockatoo-screaming-feather-plucking-explained', 'cockatoo-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'quaker-parakeet': ['iguana-fireskink-quaker-overview', 'quaker-parakeet-cost-guide', 'quaker-parakeet-handling-guide', 'quaker-parakeet-health-issues-guide', 'quaker-parakeet-tank-setup-guide', 'quaker-parakeet-enrichment-guide', 'bird-household-hazards-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
  ...
  'parrotlet': ['bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide'],
