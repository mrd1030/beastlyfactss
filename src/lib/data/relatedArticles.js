...
export const RELATED_ARTICLES = {
  ...
  'cherry-shrimp': ['aquarium-cycling-guide', 'aquarium-filtration-guide', 'fish-quarantine-and-treatment-guide', 'spotting-a-sick-fish-guide', 'freshwater-ph-gh-kh-guide', 'cooling-an-aquarium-without-a-chiller-guide', 'cherry-amano-ghost-shrimp-overview'],
  'amano-shrimp': ['aquarium-cycling-guide', 'aquarium-filtration-guide', 'freshwater-ph-gh-kh-guide', 'fish-quarantine-and-treatment-guide', 'spotting-a-sick-fish-guide', 'cooling-an-aquarium-without-a-chiller-guide', 'cherry-amano-ghost-shrimp-overview'],
  'ghost-shrimp': ['aquarium-cycling-guide', 'aquarium-filtration-guide', 'fish-quarantine-and-treatment-guide', 'spotting-a-sick-fish-guide', 'freshwater-ph-gh-kh-guide', 'cooling-an-aquarium-without-a-chiller-guide', 'cherry-amano-ghost-shrimp-overview'],
