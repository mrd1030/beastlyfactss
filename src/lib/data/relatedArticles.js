...
export const RELATED_ARTICLES = {
  ...
  'rat': ['rat-cost-guide', 'rat-handling-guide', 'rat-health-issues-guide', 'rat-tank-setup-guide', 'rat-feeding-guide', 'rat-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide', 'small-mammal-grooming-nails-molting-guide', 'rat-mouse-flying-squirrel-overview'],
  ...
  'degu': ['degu-gerbil-overview', 'degu-cost-guide', 'degu-handling-guide', 'degu-health-issues-guide', 'degu-tank-setup-guide', 'degu-enrichment-guide', 'small-mammal-enterotoxemia-guide', 'small-mammal-temperature-heat-stress-guide', 'small-mammal-vet-visits-and-travel-guide', 'small-mammal-grooming-nails-molting-guide', 'degu-vs-chinchilla-guide'],
  ...
  'whites-tree-frog': ['whites-tree-frog-cost-guide', 'whites-tree-frog-handling-guide', 'whites-tree-frog-health-issues-guide', 'whites-tree-frog-tank-setup-guide', 'whites-tree-frog-enrichment-guide', 'reptile-salmonella-hygiene-guide', 'amphibian-tubbing-and-salt-baths-guide', 'amphibian-quarantine-and-water-guide', 'hamster-skink-whitestreefrog-pacmanfrog-overview'],
  ...
  'lovebird': ['lovebird-cost-guide', 'lovebird-handling-guide', 'lovebird-health-issues-guide', 'lovebird-tank-setup-guide', 'lovebird-enrichment-guide', 'bird-household-hazards-guide', 'avian-gastric-yeast-guide', 'bird-quarantine-guide', 'bird-droppings-guide', 'bird-photoperiod-sleep-guide', 'bird-pellet-conversion-guide', 'bird-wing-clipping-guide', 'bird-emergency-travel-guide', 'bird-sexing-weight-body-condition-guide', 'bird-chronic-egg-laying-guide', 'bird-feather-loss-and-molt-guide', 'choosing-a-pet-bird-guide', 'avian-polyomavirus-guide', 'bird-body-language-guide', 'bird-colony-aviary-keeping-guide', 'bird-feather-dust-air-quality-guide', 'parrot-training-guide', 'bird-first-aid-kit-and-grooming-guide', 'long-lived-pet-succession-planning-guide', 'rehomed-parrot-guide', 'sulcata-hedgehog-lovebird-guppy-overview', 'lovebird-vs-budgie-guide'],
