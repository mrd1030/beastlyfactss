...
export const RELATED_ARTICLES = {
  ...
  'ferret': ['ferret-adrenal-disease-guide', 'ferret-legal-guide', 'ferret-cost-guide', 'ferret-handling-guide', 'ferret-health-issues-guide', 'ferret-tank-setup-guide', 'ferret-feeding-guide', 'ferret-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide'],
  ...
  'rabbit': ['rabbit-gi-stasis-guide', 'rabbit-cost-guide', 'rabbit-handling-guide', 'rabbit-health-issues-guide', 'rabbit-tank-setup-guide', 'rabbit-feeding-guide', 'rabbit-enrichment-guide', 'small-mammal-enterotoxemia-guide', 'small-mammal-temperature-heat-stress-guide', 'small-mammal-vet-visits-and-travel-guide'],
  ...
  'hamster': ['hamster-cost-guide', 'hamster-handling-guide', 'hamster-health-issues-guide', 'hamster-tank-setup-guide', 'hamster-feeding-guide', 'hamster-enrichment-guide', 'small-mammal-enterotoxemia-guide', 'small-mammal-temperature-heat-stress-guide', 'small-mammal-vet-visits-and-travel-guide'],
  'rat': ['rat-cost-guide', 'rat-handling-guide', 'rat-health-issues-guide', 'rat-tank-setup-guide', 'rat-feeding-guide', 'rat-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide'],
  ...
  'degu': ['degu-gerbil-overview', 'degu-cost-guide', 'degu-handling-guide', 'degu-health-issues-guide', 'degu-tank-setup-guide', 'degu-enrichment-guide', 'small-mammal-enterotoxemia-guide', 'small-mammal-temperature-heat-stress-guide', 'small-mammal-vet-visits-and-travel-guide'],
  'gerbil': ['degu-gerbil-overview', 'gerbil-cost-guide', 'gerbil-handling-guide', 'gerbil-health-issues-guide', 'gerbil-tank-setup-guide', 'gerbil-enrichment-guide', 'small-mammal-temperature-heat-stress-guide', 'small-mammal-vet-visits-and-travel-guide'],
  ...
  'hedgehog': ['hedgehog-cost-guide', 'hedgehog-handling-guide', 'hedgehog-health-issues-guide', 'hedgehog-tank-setup-guide', 'hedgehog-feeding-guide', 'hedgehog-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide'],
  ...
  'sugar-glider': ['sugar-glider-cost-guide', 'sugar-glider-handling-guide', 'sugar-glider-health-issues-guide', 'sugar-glider-tank-setup-guide', 'sugar-glider-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide'],
