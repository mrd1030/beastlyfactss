...
export const RELATED_ARTICLES = {
  ...
  'praying-mantis': ['praying-mantis-ootheca-guide', 'praying-mantis-cost-guide', 'praying-mantis-handling-guide', 'praying-mantis-health-issues-guide', 'praying-mantis-tank-setup-guide', 'praying-mantis-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide', 'invertebrate-quarantine-cleaning-and-escapes-guide', 'invertebrate-emergency-travel-shipping-guide', 'boa-glider-mantis-tetra-overview', '10-surprising-praying-mantis-facts'],
  ...
  'emperor-scorpion': ['emperor-scorpion-legal-guide', 'emperor-scorpion-cost-guide', 'emperor-scorpion-handling-guide', 'emperor-scorpion-health-issues-guide', 'emperor-scorpion-tank-setup-guide', 'emperor-scorpion-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide', 'invertebrate-quarantine-cleaning-and-escapes-guide', 'invertebrate-emergency-travel-shipping-guide', 'koi-conure-slider-scorpion-overview', 'tarantula-vs-emperor-scorpion-guide', '10-surprising-emperor-scorpion-facts'],
  ...
  'blue-tongue-skink': ['blue-tongue-skink-legal-guide', 'blue-tongue-skink-cost-guide', 'blue-tongue-skink-handling-guide', 'blue-tongue-skink-health-issues-guide', 'blue-tongue-skink-tank-setup-guide', 'blue-tongue-skink-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'reptile-quarantine-guide', 'reptile-shedding-complete-guide', 'iguana-fireskink-quaker-overview', 'hamster-skink-whitestreefrog-pacmanfrog-overview'],
  ...
  'sugar-glider': ['sugar-glider-legal-guide', 'sugar-glider-cost-guide', 'sugar-glider-handling-guide', 'sugar-glider-health-issues-guide', 'sugar-glider-tank-setup-guide', 'sugar-glider-enrichment-guide', 'small-mammal-vet-visits-and-travel-guide', 'small-mammal-grooming-nails-molting-guide', 'boa-glider-mantis-tetra-overview', 'rat-mouse-flying-squirrel-overview'],
  ...
  'ackie-monitor': ['ackie-monitor-legal-guide', 'ackie-monitor-cost-guide', 'ackie-monitor-handling-guide', 'ackie-monitor-health-issues-guide', 'ackie-monitor-tank-setup-guide', 'ackie-monitor-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'reptile-quarantine-guide', 'reptile-shedding-complete-guide', 'ackie-milksnake-mhc-angelfish-overview'],
  'milk-snake': ['milk-snake-legal-guide', 'milk-snake-cost-guide', 'milk-snake-handling-guide', 'milk-snake-health-issues-guide', 'milk-snake-tank-setup-guide', 'milk-snake-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'reptile-quarantine-guide', 'snake-sexing-growth-body-condition-guide', 'snake-shedding-humidity-myth-guide', 'reptile-shedding-complete-guide', 'ackie-milksnake-mhc-angelfish-overview', 'milk-snake-vs-corn-snake-guide'],
  'hissing-cockroach': ['madagascar-hissing-cockroach-legal-guide', 'madagascar-hissing-cockroach-feeding-guide', 'madagascar-hissing-cockroach-cost-guide', 'madagascar-hissing-cockroach-handling-guide', 'madagascar-hissing-cockroach-health-issues-guide', 'madagascar-hissing-cockroach-tank-setup-guide', 'madagascar-hissing-cockroach-enrichment-guide', 'invertebrate-pesticide-hazards-guide', 'invertebrate-rehousing-guide', 'invertebrate-quarantine-cleaning-and-escapes-guide', 'invertebrate-emergency-travel-shipping-guide', '10-surprising-hissing-cockroach-facts', 'ackie-milksnake-mhc-angelfish-overview'],
