...
export const RELATED_ARTICLES = {
  ...
  'veiled-chameleon': ['chameleon-hydration-drippers-misters-fogging', 'veiled-chameleon-cost-guide', 'veiled-chameleon-handling-guide', 'veiled-chameleon-health-issues-guide', 'veiled-chameleon-tank-setup-guide', 'veiled-chameleon-enrichment-guide'],
  'chameleon': ['chameleon-hydration-drippers-misters-fogging', 'jacksons-chameleon-cost-guide', 'jacksons-chameleon-handling-guide', 'jacksons-chameleon-health-issues-guide', 'jacksons-chameleon-tank-setup-guide', 'jacksons-chameleon-enrichment-guide'],
  ...
  'garter-snake': ['garter-snake-legal-guide', 'garter-snake-cost-guide', 'garter-snake-handling-guide', 'garter-snake-health-issues-guide', 'garter-snake-tank-setup-guide', 'garter-snake-feeding-guide', 'garter-snake-enrichment-guide'],
  ...
  'dog-beagle': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'why-your-dog-needs-daily-exercise'],
  'dog-border-collie': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'why-your-dog-needs-daily-exercise', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
  'dog-bulldog': ['conformation-breeding-laws-guide', 'pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide'],
  'dog-dachshund': ['conformation-breeding-laws-guide', 'pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'ivdd-and-chondrodystrophy-guide', 'periodontal-dental-disease-guide'],
  'dog-french-bulldog': ['conformation-breeding-laws-guide', 'pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'french-bulldog-feeding-guide'],
  'dog-german-shepherd': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'dog-bloat-gdv-guide', 'german-shepherd-feeding-guide', 'golden-retriever-vs-german-shepherd-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  'dog-golden-retriever': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'dog-bloat-gdv-guide', 'golden-retriever-feeding-guide', 'golden-retriever-vs-german-shepherd-guide'],
  'dog-labrador': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'dog-bloat-gdv-guide', 'why-your-dog-needs-daily-exercise'],
  'dog-rottweiler': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'pet-obesity-body-condition-guide', 'dog-bloat-gdv-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  'dog-siberian-husky': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'hip-and-elbow-dysplasia-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  ...
  'cat-american-shorthair': ['pet-dna-test-results-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-bengal': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-domestic-shorthair': ['conformation-breeding-laws-guide', 'pet-dna-test-results-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-maine-coon': ['pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'feline-kidney-disease-ckd-pkd-guide', 'hip-and-elbow-dysplasia-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  'cat-persian': ['conformation-breeding-laws-guide', 'pet-dna-test-results-guide', 'inherited-eye-disease-dogs-cats-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'brachycephalic-airway-syndrome-boas-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  'cat-ragdoll': ['pet-dna-test-results-guide', 'feline-kidney-disease-ckd-pkd-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  ...
  'red-eared-slider': ['red-eared-slider-legal-guide', 'red-eared-slider-cost-guide', 'red-eared-slider-handling-guide', 'red-eared-slider-health-issues-guide', 'red-eared-slider-tank-setup-guide', 'red-eared-slider-feeding-guide', 'red-eared-slider-enrichment-guide'],
  ...
  'hognose-snake': ['hognose-snake-legal-guide', 'hognose-snake-cost-guide', 'hognose-snake-handling-guide', 'hognose-snake-health-issues-guide', 'hognose-snake-tank-setup-guide', 'hognose-snake-enrichment-guide'],
  'blue-tongue-skink': ['blue-tongue-skink-cost-guide', 'blue-tongue-skink-handling-guide', 'blue-tongue-skink-health-issues-guide', 'blue-tongue-skink-tank-setup-guide', 'blue-tongue-skink-enrichment-guide'],
  ...
  'sulcata-tortoise': ['sulcata-tortoise-legal-guide', 'sulcata-tortoise-cost-guide', 'sulcata-tortoise-handling-guide', 'sulcata-tortoise-health-issues-guide', 'sulcata-tortoise-tank-setup-guide', 'sulcata-tortoise-enrichment-guide'],
  ...
  'boa-constrictor': ['boa-constrictor-legal-guide', 'boa-constrictor-cost-guide', 'boa-constrictor-handling-guide', 'boa-constrictor-health-issues-guide', 'boa-constrictor-tank-setup-guide', 'boa-constrictor-enrichment-guide'],
  ...
  'ackie-monitor': ['ackie-monitor-cost-guide', 'ackie-monitor-handling-guide', 'ackie-monitor-health-issues-guide', 'ackie-monitor-tank-setup-guide', 'ackie-monitor-enrichment-guide'],
  'milk-snake': ['milk-snake-cost-guide', 'milk-snake-handling-guide', 'milk-snake-health-issues-guide', 'milk-snake-tank-setup-guide', 'milk-snake-enrichment-guide'],
  ...
  'uromastyx': ['uromastyx-cost-guide', 'uromastyx-handling-guide', 'uromastyx-health-issues-guide', 'uromastyx-tank-setup-guide', 'uromastyx-enrichment-guide'],
  ...
  'rosy-boa': ['rosy-boa-legal-guide', 'rosy-boa-cost-guide', 'rosy-boa-handling-guide', 'rosy-boa-health-issues-guide', 'rosy-boa-tank-setup-guide', 'rosy-boa-feeding-guide', 'rosy-boa-enrichment-guide'],
  ...
  'green-anole': ['green-anole-cost-guide', 'green-anole-handling-guide', 'green-anole-health-issues-guide', 'green-anole-tank-setup-guide', 'green-anole-enrichment-guide'],
  'tegu': ['argentine-tegu-legal-guide', 'argentine-tegu-cost-guide', 'argentine-tegu-handling-guide', 'argentine-tegu-health-issues-guide', 'argentine-tegu-tank-setup-guide', 'argentine-tegu-enrichment-guide'],
  ...
  'green-iguana': ['iguana-fireskink-quaker-overview', 'green-iguana-cost-guide', 'green-iguana-handling-guide', 'green-iguana-health-issues-guide', 'green-iguana-tank-setup-guide', 'green-iguana-enrichment-guide'],
  'fire-skink': ['iguana-fireskink-quaker-overview', 'fire-skink-cost-guide', 'fire-skink-handling-guide', 'fire-skink-health-issues-guide', 'fire-skink-tank-setup-guide', 'fire-skink-enrichment-guide'],
