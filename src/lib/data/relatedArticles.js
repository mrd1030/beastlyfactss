...
export const RELATED_ARTICLES = {
  ...
  'red-eared-slider': ['red-eared-slider-legal-guide', 'red-eared-slider-cost-guide', 'red-eared-slider-handling-guide', 'red-eared-slider-health-issues-guide', 'red-eared-slider-tank-setup-guide', 'red-eared-slider-feeding-guide', 'red-eared-slider-enrichment-guide', 'reptile-emergency-plan-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'tortoise-brumation-guide', 'tortoise-sexing-eggs-and-egg-binding-guide'],
  ...
  'sulcata-tortoise': ['sulcata-tortoise-legal-guide', 'sulcata-tortoise-cost-guide', 'sulcata-tortoise-handling-guide', 'sulcata-tortoise-health-issues-guide', 'sulcata-tortoise-tank-setup-guide', 'sulcata-tortoise-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'tortoise-brumation-guide', 'tortoise-sexing-eggs-and-egg-binding-guide'],
  ...
  'box-turtle': ['box-turtle-legal-guide', 'box-turtle-cost-guide', 'box-turtle-handling-guide', 'box-turtle-health-issues-guide', 'box-turtle-tank-setup-guide', 'box-turtle-enrichment-guide', 'reptile-emergency-plan-guide', 'chelonian-herpesvirus-quarantine-guide', 'reptile-stool-urates-hydration-guide', 'reptile-salmonella-hygiene-guide', 'reptile-heating-thermostats-guide', 'tortoise-brumation-guide', 'tortoise-sexing-eggs-and-egg-binding-guide'],
