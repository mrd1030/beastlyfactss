...
export const RELATED_ARTICLES = {
  ...
  'dog-beagle': ['pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'why-your-dog-needs-daily-exercise'],
  'dog-border-collie': ['why-your-dog-needs-daily-exercise', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
  'dog-bulldog': ['hip-and-elbow-dysplasia-guide', 'brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide'],
  'dog-dachshund': ['ivdd-and-chondrodystrophy-guide', 'periodontal-dental-disease-guide'],
  'dog-french-bulldog': ['brachycephalic-airway-syndrome-boas-guide', 'ivdd-and-chondrodystrophy-guide', 'french-bulldog-feeding-guide'],
  'dog-german-shepherd': ['hip-and-elbow-dysplasia-guide', 'dog-bloat-gdv-guide', 'german-shepherd-feeding-guide', 'golden-retriever-vs-german-shepherd-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  'dog-golden-retriever': ['hip-and-elbow-dysplasia-guide', 'dog-bloat-gdv-guide', 'golden-retriever-feeding-guide', 'golden-retriever-vs-german-shepherd-guide'],
  'dog-labrador': ['hip-and-elbow-dysplasia-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'dog-bloat-gdv-guide', 'why-your-dog-needs-daily-exercise'],
  'dog-rottweiler': ['hip-and-elbow-dysplasia-guide', 'pet-obesity-body-condition-guide', 'dog-bloat-gdv-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  'dog-siberian-husky': ['hip-and-elbow-dysplasia-guide', 'why-your-dog-needs-daily-exercise', 'alpha-wolf-myth-what-the-research-actually-says'],
  'cat-universal': ['cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
  'cat-american-shorthair': ['cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-bengal': ['cardiomyopathy-in-cats-and-dogs-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-domestic-shorthair': ['cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them'],
  'cat-maine-coon': ['hip-and-elbow-dysplasia-guide', 'cardiomyopathy-in-cats-and-dogs-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  'cat-persian': ['cardiomyopathy-in-cats-and-dogs-guide', 'brachycephalic-airway-syndrome-boas-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  'cat-ragdoll': ['cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide', 'periodontal-dental-disease-guide', 'cat-hairball-vs-vomiting-guide'],
  'cat-scottish-fold': ['cardiomyopathy-in-cats-and-dogs-guide', 'pet-obesity-body-condition-guide'],
  'cat-siamese': ['periodontal-dental-disease-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
  'cat-sphynx': ['cardiomyopathy-in-cats-and-dogs-guide', 'periodontal-dental-disease-guide', 'why-cats-need-mental-enrichment-and-how-boredom-can-break-them', 'when-your-pet-wont-stop-pacing-or-hiding-what-anxious-pet-behavior-is-really-telling-you'],
