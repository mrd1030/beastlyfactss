...
export const RELATED_ARTICLES = {
  ...
  'ghost-shrimp': ['aquarium-cycling-guide', 'aquarium-filtration-guide', 'freshwater-ph-gh-kh-guide', 'cooling-an-aquarium-without-a-chiller-guide', 'cherry-amano-ghost-shrimp-overview'],
