...
- "Is a budgie the same thing as a parakeet?" (see Priority #4)
- "Boa constrictor vs python" (2 hits) — different families, commonly confused
- "Large vs giant breed dogs" (2 hits) and "what size dog is medium" (4 hits) — map directly to the site's existing Large/Medium/Small Breed Dog guides

**Small variant/morph notes worth one line each:** Red vs Yellow Ackie Monitor (2 hits — real color/locality variants of the same species), Pineapple vs standard Green Cheek Conure (1 hit — a color mutation, not a different bird), "Tabby is a coat pattern, not a breed" clarification for Domestic Shorthair/Bengal guides (3 hits combined).
