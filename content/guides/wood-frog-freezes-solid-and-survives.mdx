...
seoDescription: "Wood frogs freeze up to 70 percent of their body water, survive to minus 16 Celsius, and are now studied as a model for organ preservation research."
...
Freezing an organ would solve that, and it fails for exactly the reasons wood frog freezing should fail: ice damage and solute concentration. So the frog is now a working model in cryopreservation research, and the questions are specific. How does the liver mobilize that much glucose that fast? What keeps the cells from apoptosis during the ischemic period? Wood frogs have been shown to run an anti-apoptotic response during anoxia and recovery, which is a distinct problem from the ice itself.
