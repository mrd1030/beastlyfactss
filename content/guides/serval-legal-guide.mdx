...
seoTitle: "Are Servals Legal? Banned Outright in 15 of 47 Jurisdictions"
...
# === SEO & Descriptions ===
excerpt: "Twenty-nine of the forty-seven jurisdictions we checked restrict the serval, fifteen of them outright. Ohio bans the cat and expressly legalizes its hybrid, and Montana clears it by name."
seoDescription: "Serval legality: 15 of 47 jurisdictions ban it outright, Ohio bans the cat but legalizes its savannah cat hybrid, and Texas requires $100,000 insurance."
...
The serval is the most restricted animal in this matrix. Of the forty-seven jurisdictions we have read, twenty-nine place some restriction on it and fifteen ban it outright with no permit to apply for.
...
<ComparisonTable
  ...
  rows={[
    ["Banned outright", "15", "GA, NY, NYC, CT, OR, MN, MD, IA, RI, NH, AK, NE, HI, DC, NM"],
    ["Permit required", "12", "OH, TX, VA, ID, SD, IN, WY, ME, AR, PA, VT, ND"],
    ["Conditions apply", "3", "CA, AZ and UT, each by a whole-group restriction rather than by naming the serval"],
    ["No restriction found", "16", "WA, IL, KY, MO, KS, SC, MT, AL, MS, LA, OK, NC, MI, NV, WI, WV"],
