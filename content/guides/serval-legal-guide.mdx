...
<ComparisonTable
  ...
  rows={[
    ...
    ["Permit required", "11", "OH, TX, VA, ID, SD, IN, WY, ME, AR, PA, VT"],
    ["Conditions apply", "3", "CA, AZ and UT, each by a whole-group restriction rather than by naming the serval"],
    ["No restriction found", "15", "WA, IL, KY, MO, KS, SC, MT, AL, MS, LA, OK, NC, MI, NV, WI"],
    ["Unclear from the text", "3", "TN, WV, ND"],
  ]}
/>
