...
noIndex: false
factFile: true
myth: "Betty the crow bending a wire into a hook was the clearest case of invention in any animal."
truth: "Wild New Caledonian crows bend twigs using the same motion. She applied a species-typical move to an unfamiliar material."
animal: "Crow"
---
...
When most people think of animal tool use, they picture a chimpanzee poking a stick into a termite mound. Impressive, sure. But crows have taken tool use to a level that surprised the scientific community.
...
Self-recognition is where crows come up short, at least on the standard test. In the mirror mark test an animal gets a spot it can only see in a reflection, and it passes if it investigates the spot on its own body. Among corvids, only the Eurasian magpie and the Indian house crow have passed, and attempts to repeat both results have largely failed. Large-billed, New Caledonian, carrion and hooded crows have all failed to give conclusive evidence, and ravens failed in a 2022 comparison. Whether that says something about crows or about the test is a fair question, and it is the same argument that runs through the [dolphin mirror studies](/blog/do-dolphins-have-names-what-the-research-shows/): the mark test leans on vision and on self-touching, and what passing it proves is contested.
...
They also make and modify tools, which the [crow Beastfile](/beastlypedia/crow/) covers alongside the face-recognition work.
...
- [Vanhooland, Szabó, Bugnyar, & Massen (2022). A comparative study of mirror self-recognition in three corvid species. Animal Cognition.](https://pmc.ncbi.nlm.nih.gov/articles/PMC9876878/)
