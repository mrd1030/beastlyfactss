...
In one famous experiment, a New Caledonian crow named Betty was given a straight piece of wire and a small bucket of food at the bottom of a tube. Without any training, Betty bent the wire into a hook and used it to fish the bucket out. She did this spontaneously, on her own, the first time she encountered the problem. The researchers were so surprised they ran the experiment again. Betty did it again.
...
Urban crows have developed their own clever techniques. In Japan, carrion crows have been documented placing hard-shelled nuts on crosswalks, waiting for cars to crack them open, and then waiting for the pedestrian signal before walking out to collect the pieces. They figured out traffic lights. On their own.
...
They can. Rooks (a corvid closely related to crows) were presented with a tube of water containing a floating treat just out of reach. The birds quickly figured out that dropping stones into the tube would raise the water level. They chose larger stones over smaller ones (more efficient), chose solid objects over hollow ones (which would not displace as much water), and chose to drop stones into the water-filled tube rather than a sand-filled one next to it. They understood the causal relationship between their actions and the outcome.

This kind of causal reasoning, understanding why something works rather than just that it works, was long considered a hallmark of human cognition. Corvids keep crashing that exclusive club.
...
Crows are scatter-hoarders. They cache food in hundreds or even thousands of locations, hiding seeds, nuts, and other morsels for later retrieval. And here is the thing: they actually remember where they put it all. Studies have shown that corvids can remember the locations of thousands of cached food items, and they can do so months later.
...
Crows are also sneaky about their caching. If they notice another crow watching them hide food, they will come back later and move it to a new location. They understand that the observer has information that could be used against them, and they take steps to protect their stash. This requires a theory of mind, the ability to model what another individual knows. It is a cognitive feat that even young human children take years to develop.
