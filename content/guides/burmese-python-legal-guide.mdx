...
# === SEO & Descriptions ===
excerpt: "The Burmese python has been federal injurious wildlife since 2012, and most people assume that settles it. A 2017 D.C. Circuit ruling took the interstate half of that ban away, which is why twenty-nine jurisdictions still have no rule of their own."
...
faqs:
  ...
  - q: "What did the 2017 court ruling change?"
...
That is why the state map matters, and why twenty-nine jurisdictions on it still have no rule of their own.

## Where Burmese Pythons Stand
...
<ComparisonTable
  ...
  rows={[
    ...
    ["West Virginia", "Permit required", "§ 20-2-13 bars possessing live wildlife from without the state without an importation permit; no snake is on the state's dangerous wild animal list"],
    ["The other 29", "Legal", "No state rule reaches the species"],
  ]}
/>
...
West Virginia never names the Burmese python, and no species list reaches it. A Burmese python is a reptile and a Southeast Asian species, so it is wildlife from without the state on any route into West Virginia. That puts it under [W. Va. Code § 20-2-13](/exotic-pet-laws/state/west-virginia/#burmese-python), which bars bringing live wildlife in from out of state, or keeping it there, without an importation permit from the director. The state's definition of wildlife covers reptiles with no captive-bred exception, so buying from a breeder does not change the answer.
...
Twenty-nine jurisdictions have no state rule reaching the Burmese python. Ten ban it. Nine require a permit. Three attach a condition, one of which is a tape measure. One is unresolved.

The gap between what people believe and what the law says is unusually wide here. A federal injurious wildlife listing sounds like a ban and is not one: it never touched ownership, and since 2017 it does not touch movement between continental states either. Meanwhile the states that do ban this animal mostly did it themselves, and two of them did it by pointing at the federal list rather than by writing their own.
...
The [boa constrictor legal guide](/blog/boa-constrictor-legal-guide/) covers the species FWS considered in the same rulemaking and explicitly declined to list, and the [ball python legal guide](/blog/ball-python-legal-guide/) covers the python that is legal nearly everywhere. The [tiger salamander legal guide](/blog/tiger-salamander-legal-guide/) walks through a more recent injurious wildlife listing and what it does and does not do, and the [exotic pet legal hub](/exotic-pet-laws/) explains how state rule structures differ.
