...
Every single heat source needs to run through a thermostat, no exceptions. This isn't a suggestion, it's what prevents burns and fire hazards, covered further in our [Ball Python health issues guide](/blog/ball-python-health-issues-guide/). Skip hot rocks entirely.
