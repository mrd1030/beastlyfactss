...
noIndex: false
factFile: true
myth: "A wombat has a square sphincter."
truth: "There is no such thing. The cube is shaped much further up, by stiff and stretchy bands in the intestine wall."
animal: "Wombat"
---
...
<Figure src="/assets/images/why-wombats-produce-cube-shaped-droppings-1.jpg" alt="Diagram showing how two stiff bands in a wombat's intestine wall create four corners in cube-shaped droppings, with a table comparing water content between the proximal colon, distal colon, and human feces" caption="Not a square anus, CT scans show it's round like every other mammal's. Two stiff bands in the intestine wall push two corners directly, and drag the other two." shareable />
...
That intestine is long. A fully grown bare-nosed wombat has 6 to 9 meters of it, feeding a hindgut fermentation system that squeezes a living out of grasses and sedges. In the proximal colon the contents are a yellow-green slurry with no shape at all. By the distal colon, they are dark, dry and cubic.
...
<ComparisonTable
  ...
  rows={[
    ...
    ["Wombat distal colon (last meter)", "0.53", "Fully formed cubes"],
    ["Human feces (for comparison)", "0.74", "Cylindrical"],
  ]}
/>
...
The team tested this with dough models shaped and sized like real wombat scats, dropped from 20 cm, roughly the height of an adult wombat's rear. On an 8 degree slope, the cubes ended up an average of 20 cm closer to the impact point than spheres did. On flat ground the cubes actually traveled further, so the advantage is specific to the sloped, raised surfaces wombats choose.
...
Wombats are not the only animal whose toilet habits turn out to be load-bearing. [A sloth climbs all the way down to the forest floor to defecate](/blog/why-a-sloth-climbs-down-to-defecate/), a weekly trip that is the single most dangerous thing it does, and the explanation is stranger than the behavior.
...
The cartilage-reinforced rump a wombat uses to plug its own burrow is a separate piece of engineering, and the [wombat Beastfile](/beastlypedia/wombat/) has it.
...
- [Wombats (NSW Department of Climate Change, Energy, the Environment and Water)](https://www.environment.nsw.gov.au/topics/animals-and-plants/native-animals/native-animal-facts/land-mammals/wombats)
