...
seoDescription: "A 2013 study proved dung beetles steer by the Milky Way: cardboard visors and a Johannesburg planetarium earned the team an Ig Nobel Prize."
...
noIndex: false
factFile: true
myth: "A dung beetle rolling in a straight line is just going straight."
truth: "It steers by the Milky Way. Proving it took cardboard visors, a planetarium in Johannesburg, and a lot of patience."
animal: "Dung Beetle"
---
...
The animal doing this has a brain a few cubic millimeters in size. The reference point it uses is a galaxy.
...
The measurement is neat: time to cross a two meter circular arena. With the Milky Way visible, beetles crossed in roughly 40 seconds. Under cloud, the same crossing took close to two minutes, because a beetle that keeps turning covers far more ground to get the same distance.
...
<FunFact>
Dacke and colleagues were awarded the 2013 Ig Nobel Prize in Biology and Astronomy for this work. The Ig Nobels honor research that makes people laugh and then think, and this is the archetype: the finding sounds absurd, the method is rigorous, and the conclusion holds. [The wombat cube study](/blog/why-wombats-produce-cube-shaped-droppings/) won the same prize six years later.
</FunFact>
