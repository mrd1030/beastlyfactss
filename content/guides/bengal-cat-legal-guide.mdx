...
seoTitle: "Are Bengal Cats Legal? F1 to F5 Rules by State"
...
# === SEO & Descriptions ===
excerpt: "The same Bengal is a domestic cat in Indiana, legal in Iowa only from the fourth generation, and in Minnesota caught by one sentence of a definition and exempted by another. Four states draw the line four different ways, and one draws it by weight."
seoDescription: "Bengal cat laws by state: New York's five-generation rule, Iowa's F4 cutoff, Maryland's 30-pound test, explained simply."
...
To see this at a glance, our [interactive map of bengal cat laws](/exotic-pet-laws/bengal-cat/) shades every state that restricts one, and clicking a state gives you the rule it comes from.
