...
excerpt: "Elephants produce calls too low for people to hear, carrying for kilometers across open country. Some of that signal travels through the ground, and elephants pick it up through their feet."
...
description: "Elephant rumbles drop below 20 Hz, travel for kilometers, and have a seismic component elephants detect through their feet and skeleton."
canonicalUrl: ""
readingTime: 7
...
Elephant rumbles sit mostly between about 10 and 40 Hz, with the fundamental frequency of many calls under the human threshold and harmonics reaching well above it. What a person standing nearby actually hears is the upper harmonics, which is why elephants have always sounded like they make a low grumbling noise rather than sounding silent. The bulk of the signal was simply below the floor.
...
The trunk is its own piece of engineering, tens of thousands of muscle units and no bone in any of it, and the [African elephant Beastfile](/beastlypedia/african-elephant/) takes that up.
...
<Sources>
- ["A throbbing in the air: The discovery of infrasonic communication among elephants", BioScience 49(5):353-358 (1999)](https://academic.oup.com/bioscience/article/49/5/353/227165)
- [Seismic communication, ElephantVoices](https://www.elephantvoices.org/elephant-communication/seismic-communication.html)
- [O'Connell-Rodwell, "Keeping an 'Ear' to the Ground: Seismic Communication in Elephants", Physiology 22(4):287-294 (2007)](https://doi.org/10.1152/physiol.00008.2007)
- [Bouley et al., "The distribution, density and three-dimensional histomorphology of Pacinian corpuscles in the foot of the Asian elephant and their potential role in seismic communication", Journal of Anatomy 211(4):428-435 (2007)](https://doi.org/10.1111/j.1469-7580.2007.00792.x)
</Sources>
