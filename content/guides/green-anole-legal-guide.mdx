...
West Virginia never names the green anole, and no species list reaches it. A green anole is a reptile with no West Virginia population, so it is wildlife from without the state on any route into West Virginia. That puts it under [W. Va. Code § 20-2-13](/exotic-pet-laws/state/west-virginia/#green-anole), which bars bringing live wildlife in from out of state, or keeping it there, without an importation permit from the director. The state's definition of wildlife covers reptiles with no captive-bred exception, so buying from a breeder does not change the answer.

Being non-native is also what keeps it clear of the harsher rule. W. Va. C.S.R. § 58-73-1.1 prohibits possessing any native West Virginia reptile the rule does not list, and the WVDNR checklist of the state's six lizards names the eastern six-lined racerunner, four skinks and the eastern fence lizard, with no anole among them.
