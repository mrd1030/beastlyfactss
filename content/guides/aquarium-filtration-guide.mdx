...
<ComparisonTable
  ...
  rows={[
    ["Hang-on-back (HOB)", "Standard community tanks, easiest to maintain", "Limited media capacity versus a canister"],
    ["Canister", "Large or heavily stocked tanks needing serious turnover", "Most expensive, most involved to open and clean"],
    ["Sponge", "Fry, shrimp, bettas, and axolotls, gentle low-flow intake", "Limited chemical filtration, needs a separate air pump"],
