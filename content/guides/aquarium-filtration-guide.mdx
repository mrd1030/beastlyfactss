...
That's tank volume multiplied by your target turnover, nothing more. A 40-gallon community tank at the middle of that range needs a filter rated somewhere around 240 to 320 gph, not a filter merely labeled "up to 40 gallons," since that label and the actual gph behind it can vary a lot between brands. A [goldfish tank](/blog/goldfish-tank-setup-guide/) sits in the heavy column from the start, since its bioload runs well above most other freshwater fish of the same size, and stocking density is what pushes any tank from the community column into the heavy one.
...
The same logic extends to medicating a tank. Antimicrobial treatments tend to kill the nitrifying bacteria in a biofilter along with their intended target, and copper is harder on it still: it damages the biofilter's bacteria, and a temporary rise in ammonia and nitrite follows for weeks to months after treatment. Weeks to months is the part worth planning around. Any time you're treating a tank for illness, expect the filter's biological capacity to take a real hit alongside the fish getting the medication, and keep testing ammonia and nitrite long after the course itself has finished.
...
The nitrifying bacteria that run your biological filtration need continuous, oxygenated flow to survive, not because they're fragile in some abstract sense, but because nitrification itself is an oxygen-consuming process. There is a real number on that dependency: nitrifying bacteria become inefficient once dissolved oxygen in the biofilter drops below roughly 2 ppm, and biological filters do not take rapid change well. A brief pause while you're cleaning the filter itself is normal and harmless. A longer stoppage, a power outage or a filter left unplugged overnight, is a different situation with its own restart procedure, since simply flipping a long-dead filter back on can push a slug of stagnant, oxygen-poor water and dead bacteria straight into the tank. Checking and safely restarting a filter that has been off for hours follows the steps in the [aquarium power outage and transport guide](/blog/aquarium-power-outage-and-transport-guide/).
