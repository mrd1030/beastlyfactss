...
<ComparisonTable
  ...
  rows={[
    ...
    ["Virginia", "Banned, in any number", "The eastern tiger salamander is a tier I amphibian Species of Greatest Conservation Need, and 4VAC15-360-10(A)(6) withholds private possession of those"],
    ...
    ["Missouri, Oklahoma, West Virginia, Maine, Vermont, New Mexico, Colorado", "Permit", "Native-wildlife or importation permits, several of which are not written for a pet"],
    ...
    ["Eleven more", "Conditions apply", "Caps, sourcing rules or license requirements in ID, RI, HI, WI, UT, PA, MI, IL, MN, Kansas and Texas"],
