...
<ComparisonTable
  ...
  rows={[
    ["New York", "Effectively banned, captive-bred included", "Native snakes are small game with no open season, and the only possession licence is issued for propagation, science or exhibition, never for a pet"],
    ...
    ["Illinois, Indiana, Nebraska, Oklahoma, Texas", "Native caps and licences", "Each treats the garter snake as its own wildlife. Nebraska allows ten per species, Oklahoma six with a hunting licence, and Indiana governs sale regardless of place of origin"],
