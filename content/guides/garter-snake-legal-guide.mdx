...
<ComparisonTable
  ...
  rows={[
    ...
    ["Kansas", "Two per domicile", "Native wildlife under K.A.R. 115-20-2, takeable for personal use and capped at two of any one reptile species per person or address"],
    ["Virginia", "One per physical address", "The eastern gartersnake is on the department's native list, so 4VAC15-360-10(A) applies rather than the exotic permit table"],
  ]}
/>
