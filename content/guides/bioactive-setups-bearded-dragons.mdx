...
Nothing changes here from a normal setup. You still need strong UVB (Arcadia 12 percent or similar is popular), a proper basking spot around 100 to 105 degrees on the surface, and a cool side in the low 70s. If you want the deeper reasoning behind why UVB strength matters as much as it does, see our [complete guide to UVB lighting](/blog/uvb-lighting-complete-guide/).
