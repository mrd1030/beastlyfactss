#!/usr/bin/env python3
"""Assemble the budgie care package.
...
SRC = os.path.normpath(os.path.join(HERE, "..", "budgie.html"))
COVER = os.path.normpath(os.path.join(HERE, "..", "..", "images", "budgie-cover-2.jpg"))
...
SECTIONS = [
    ...
    ("Section 02 &middot; Full Care Guide", [
        ...
        ("flock", "One Budgie or Two, and the Talking Trade-Off"),
        ...
        ("sexing", "Sexing by Cere, Weight &amp; Body Condition"),
    ...
    ("Section 03 &middot; Health &amp; Common Issues", [
        ...
        ("liver", "Obesity, Fatty Liver &amp; Tumors"),
        ("respiratory", "Respiratory Disease &amp; Psittacosis"),
        ("viral", "Polyomavirus, French Moult &amp; PBFD"),
        ("minor", "Scaly Face Mites, Megabacteriosis &amp; Goiter"),
...
FOOT = ('<div class="pagefoot"><span class="brand">Beastly Facts</span>'
        '<span>Budgie Care Package</span><span>%d</span></div>')
