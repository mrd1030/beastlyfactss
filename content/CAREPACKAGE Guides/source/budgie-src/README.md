...
`../budgie.html` is generated. Edit the fragments here, then:

    python3 build.py                                 # assemble the source
    node ../_render.mjs budgie "Budgie" 2.0 --measure # overflow check
    node ../_render.mjs budgie "Budgie" 2.0           # render the PDF
...
Content cut to make pages fit goes in `../../notes/budgie-v3-notes.md`, never in the bin.
