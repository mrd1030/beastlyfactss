...
Rabbit's 2.0 and Hamster's 3.0 were archived here in September 2026 by the small
mammal cross-check. Its other earlier build is the pre-t3 one named above, which is not
