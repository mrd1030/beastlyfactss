...
Stopped mid-work to save credits (partial edits are in this commit, unreviewed, citations not yet verified):
- R5: ackie monitor, boa, leopard gecko, savannah monitor, veiled chameleon
- R6: mourning, gargoyle, leaf-tailed gecko, garter snake, red-footed tortoise (was editing the gargoyle cost guide)
- N2: fun facts
- N3: shared class guides, including the new reptile-salmonella-hygiene-guide cleaning schedule and reptile-quarantine-guide buying and vet sections that species pages link to
- N4: chronicles and overviews (was relabeling the Otis garden prequel)

Still running at checkpoint: R1 to R4, A1 (amphibians), N1 (wild animals).
