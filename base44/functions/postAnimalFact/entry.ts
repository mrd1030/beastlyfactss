...
const facts = [
  ...
  { id: 81, title: "Color-Changing Camouflage", emoji: "🦎", animal: "Chameleon", category: "Reptiles", fact: "Chameleons are famous for their ability to change color, but did you know it's primarily a way to communicate? They alter their hues depending on their mood and social signals, rather than just blending into their surroundings!" },
  { id: 82, title: "The Tiny Yet Mighty", emoji: "🐝", animal: "Honey Bee", category: "Weird & Wonderful", fact: "A single honey bee can visit up to 2,000 flowers in one day, making them key players in our ecosystem! Their tireless work as pollinators helps produce about one-third of the food we eat." },
  { id: 83, title: "Silent Signals", emoji: "🐙", animal: "Octopus", category: "Ocean", fact: "Octopuses have an extraordinary ability to communicate through color and texture! They can rapidly change their skin color and pattern to send signals to each other or confuse predators, making them masters of disguise." },
  { id: 84, title: "Dancing Crickets", emoji: "🐜", animal: "Cricket", category: "Weird & Wonderful", fact: "Crickets don't just chirp; they dance too! Male crickets perform elaborate moves while singing to attract females, showcasing their fitness and charm in a rhythmic ballet of nature." },
  { id: 85, title: "Multiple Personality Parrots", emoji: "🦜", animal: "African Grey Parrot", category: "Birds", fact: "African Grey Parrots are known for their exceptional intelligence and social skills, often mimicking human speech with astonishing accuracy. They can learn to use and even combine different phrases based on context!" },
  { id: 86, title: "The Tardigrade Resilience", emoji: "🌌", animal: "Tardigrade", category: "Weird & Wonderful", fact: "Tardigrades, also known as water bears, can survive extreme conditions that would obliterate most life forms! They can endure boiling water, freezing temperatures, and even the vacuum of space." },
  { id: 87, title: "Sharks Can Be Chatty", emoji: "🐋", animal: "Humpback Whale", category: "Ocean", fact: "Humpback Whales are the singers of the sea! Males produce complex songs that can last for 20 minutes and can be heard over vast distances, possibly for mating purposes." },
  ...
  { id: 89, title: "Frog Rainmakers", emoji: "🌧️", animal: "Cuban Tree Frog", category: "Weird & Wonderful", fact: "The Cuban Tree Frog's croaking sounds can be heard from miles away, echoing in the tropical night as they call for mates." },
  ...
  { id: 92, title: "Sloth Speedsters", emoji: "🦥", animal: "Three-Toed Sloth", category: "Mammals", fact: "Despite their slow reputation, Three-Toed Sloths are surprisingly good swimmers! They can hold their breath for up to 40 minutes while gliding through water." },
  { id: 93, title: "Singing Spiders", emoji: "🕷️", animal: "Common House Spider", category: "Weird & Wonderful", fact: "Some Common House Spiders produce low-frequency vibrations to attract mates and communicate with each other, turning quiet corners into a surprising concert hall!" },
  ...
  { id: 95, title: "Octopus Ink Defense", emoji: "🐙", animal: "Octopus", category: "Weird & Wonderful", fact: "When threatened, octopuses release a cloud of ink that not only obscures their escape but can also temporarily impair a predator's sense of smell!" },
  { id: 96, title: "The Purring Lemur", emoji: "🐒", animal: "Lemur", category: "Mammals", fact: "Lemurs purr just like cats, but they do it primarily to communicate with their family members, helping strengthen social bonds and keep everyone feeling safe." },
  { id: 97, title: "Birds Can Count", emoji: "🦜", animal: "African Grey Parrot", category: "Birds", fact: "African Grey Parrots can count! Studies have shown that these feathered mathematicians can understand numerical concepts, proving they are brainiacs of the avian world." },
  { id: 98, title: "Frog Freeze", emoji: "🐸", animal: "Wood Frog", category: "Reptiles", fact: "The Wood Frog can survive being frozen solid during the winter months! Once temperatures warm up, this icy amphibian thaws out and hops away as if nothing ever happened!" },
  { id: 99, title: "Fluffy Fish Friends", emoji: "🐠", animal: "Clownfish", category: "Ocean", fact: "Clownfish have a unique symbiotic relationship with sea anemones. The clownfish's mucus coating allows them to thrive among the anemone's stinging tentacles without harm!" },
  { id: 100, title: "Butterfly Birthdays", emoji: "🦋", animal: "Mayfly", category: "Weird & Wonderful", fact: "Mayflies sometimes live just a few hours as adults. These ephemeral insects spend years developing underwater before emerging, mating, and dying in the same day!" },
  ...
  { id: 103, title: "Swimmers in the Desert", emoji: "🐀", animal: "Kangaroo Rat", category: "Mammals", fact: "The kangaroo rat can survive without ever drinking water! It gets all the moisture it needs from the seeds it eats, thriving in extreme desert conditions." },
  { id: 104, title: "Feline Mustache", emoji: "😺", animal: "Sphynx Cat", category: "Dogs & Cats", fact: "Sphynx cats are naturally hairless due to a genetic mutation. These quirky kitties are known for their affectionate nature and unique whiskers that contribute to their charming personality." },
  { id: 105, title: "Glowing Oceans, No Joke!", emoji: "🐬", animal: "Dolphins", category: "Ocean", fact: "When dolphins swim at night, the substances in their skin can reflect light from bioluminescent organisms, creating a spectacular glowing effect in the water." },
  { id: 106, title: "Mission Impossible Tails", emoji: "🐒", animal: "Tamarin Monkeys", category: "Mammals", fact: "Some tamarin monkeys communicate through tail movements, conveying complex messages to their troop members with a social network as intricate as any involving humans." },
  { id: 107, title: "Egg Layers of Mystery", emoji: "🐢", animal: "Sea Turtles", category: "Reptiles", fact: "Female sea turtles can travel thousands of miles to return to the beach where they were born to lay their eggs, making them one of the most fascinating ocean explorers!" },
  { id: 108, title: "Armored Squirrels", emoji: "🦚", animal: "Pangolin", category: "Weird & Wonderful", fact: "Pangolins are the only mammals covered in scales. When threatened, they can curl up into a tight ball, using these scales as armor against predators." },
  { id: 109, title: "Underwater Fireworks", emoji: "🦑", animal: "Cuttlefish", category: "Ocean", fact: "Cuttlefish can change color and texture in the blink of an eye, using specialized skin cells called chromatophores, making them mesmerizing underwater performers!" },
  { id: 110, title: "Invisible Wings", emoji: "🦅", animal: "Red-footed Booby", category: "Birds", fact: "Red-footed boobies can dive from heights of up to 30 feet into the ocean to catch fish, and they can actually see clearly underwater thanks to their unique eye structure!" },
  { id: 111, title: "Survival Specialists", emoji: "🐢", animal: "Box Turtle", category: "Reptiles", fact: "Box turtles can live for over 100 years. They can even survive for months without food, entering a hibernation-like state to preserve energy!" },
  { id: 112, title: "Cuddle Drones", emoji: "🦔", animal: "Hedgehog", category: "Dogs & Cats", fact: "Hedgehogs can run at speeds up to 6 miles per hour! But don't be fooled by their spiny exterior; they love to curl up into little balls for cuddles when feeling safe." },
  { id: 113, title: "Super Sneaky Narwhal", emoji: "🐋", animal: "Narwhal", category: "Ocean", fact: "Narwhals are often called the unicorns of the sea. Their long, spiral tusks can grow up to 10 feet long and scientists believe they detect changes in the environment." },
  { id: 114, title: "Rollercoaster Tails", emoji: "🦜", animal: "Kookaburra", category: "Birds", fact: "Kookaburras have a laugh so distinctive it sounds like hearty human laughter! They use their famous calls to establish territory, echoing through the Australian outback at sunrise." },
  { id: 115, title: "Electric Eel Shock", emoji: "⚡", animal: "Electric Eel", category: "Weird & Wonderful", fact: "Electric eels can produce jolts of electricity up to 600 volts, enough to stun a horse! They use this electric shock for hunting and self-defense in the Amazon river basin." },
  { id: 116, title: "Climbing the Walls", emoji: "🦎", animal: "Gecko", category: "Reptiles", fact: "Geckos have microscopic hairs on their feet that allow them to stick to surfaces and run on ceilings! This amazing ability comes from van der Waals forces." },
  { id: 117, title: "Can't Stop Purring", emoji: "🐆", animal: "Cheetah", category: "Mammals", fact: "Unlike other big cats, cheetahs purr continuously even while exhaling. This unique vocalization signals contentment, making them the only large felines that never truly roar." },
  { id: 118, title: "Shrimp Anemone Alliance", emoji: "🐠", animal: "Clownfish", category: "Ocean", fact: "Clownfish and sea anemones share one of nature's most iconic partnerships. The clownfish gets shelter from the anemone's stinging tentacles, while the anemone benefits from the clownfish cleaning it." },
];
// ────────────────────────────────────────────────────────────────────────────
...
Deno.serve(async (req) => {
  try {
    ...
    console.log('postAnimalFact started. Total facts:', facts.length);
