...
// Ids only, for code that needs to know a hub page exists without pulling the
// 32KB index into the blog bundle (relatedArticles.js's care-guide row). A JS
// module rather than JSON so plain node scripts can import it too.
fs.writeFileSync(path.join('src', 'lib', 'generated', 'guide-ids.js'), '// Generated by scripts/generate-guides-index.js. Do not edit.\nexport default ' + JSON.stringify(guides.map((g) => g.id)) + ';\n', 'utf8');
