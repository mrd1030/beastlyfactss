...
6. Hub reconciliation, five species per session, one branch each, with
   ...
   dragon, leopard gecko, goldfish, and axolotl done and on main; leopard
   gecko, goldfish, and axolotl passed the species check on 2026-09-08,
   fixes on branch claude/review-species-sonnet-wewmck; ball python in
   its own session. Next: batch A (betta fish, crested gecko, guinea pig,
...
then budgie, cockatiel, cockatoo, lovebird, tarantula (batch B). Ball
python is being finished in another session. Paste this with the five
species filled in.
