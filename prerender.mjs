...
const ENCYCLOPEDIA_ANIMAL_IDS = [
  ...
  'green-anole','savannah-monitor','uromastyx','fire-skink','green-iguana',
  ...
  'hamster','hedgehog','rabbit','guinea-pig','chinchilla','ferret','sugar-glider','gerbil','degu',
  'budgie','cockatiel','conure','african-grey','lovebird','canary','cockatoo','quaker-parakeet',
...
const GUIDE_IDS = [
  ...
  'ackie-monitor','boa-constrictor','tegu','leaf-tailed-gecko','red-eared-slider','fire-skink','green-iguana',
  'hamster','rabbit','hedgehog','guinea-pig','chinchilla','sugar-glider','african-grey','gerbil','degu',
  'budgie','lovebird','tokay-gecko','african-fat-tail','uromastyx','savannah-monitor','quaker-parakeet',
